            ...
            >
              <div
                ...
                style={{
                  background:
                    f === "Normal" ? "#333"
                      : f === "Vivid" ? "linear-gradient(135deg,#ff6b6b,#ffd93d)"
                      : f === "Warm" ? "linear-gradient(135deg,#fda085,#f6d365)"
                      : f === "Cool" ? "linear-gradient(135deg,#89f7fe,#66a6ff)"
                      : f === "Fade" ? "linear-gradient(135deg,#d3cce3,#e9e4f0)"
            ...
            >
              <div
                ...
                style={{
                  ...
                  background: isHolding ? "#EE1D52" : "linear-gradient(135deg,#EE1D52,#FE2C55)",
