...
.method public constructor <init>(Landroid/content/Context;IIILandroid/widget/RemoteViews;Landroid/app/Notification;ILjava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lcom/bumptech/glide/util/k;->e(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/content/Context;

    iput-object p1, p0, Lcom/bumptech/glide/request/target/l;->b:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/bumptech/glide/request/target/l;->e:Landroid/app/Notification;

    const-string p1, "RemoteViews object can not be null!"

    invoke-static {p5, p1}, Lcom/bumptech/glide/util/k;->e(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/widget/RemoteViews;

    iput-object p1, p0, Lcom/bumptech/glide/request/target/l;->a:Landroid/widget/RemoteViews;

    iput p4, p0, Lcom/bumptech/glide/request/target/l;->f:I

    iput p7, p0, Lcom/bumptech/glide/request/target/l;->c:I

    iput-object p8, p0, Lcom/bumptech/glide/request/target/l;->d:Ljava/lang/String;
...
.method private a(Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/request/target/l;->a:Landroid/widget/RemoteViews;

    iget v1, p0, Lcom/bumptech/glide/request/target/l;->f:I

    invoke-virtual {v0, v1, p1}, Landroid/widget/RemoteViews;->setImageViewBitmap(ILandroid/graphics/Bitmap;)V

    invoke-direct {p0}, Lcom/bumptech/glide/request/target/l;->b()V
...
.method private b()V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/request/target/l;->b:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/request/target/l;->d:Ljava/lang/String;

    iget v2, p0, Lcom/bumptech/glide/request/target/l;->c:I

    iget-object v3, p0, Lcom/bumptech/glide/request/target/l;->e:Landroid/app/Notification;
...
.method public onLoadCleared(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0, p1}, Lcom/bumptech/glide/request/target/l;->a(Landroid/graphics/Bitmap;)V
...
.method public bridge synthetic onResourceReady(Ljava/lang/Object;Lcom/bumptech/glide/request/transition/f;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/bumptech/glide/request/target/l;->onResourceReady(Landroid/graphics/Bitmap;Lcom/bumptech/glide/request/transition/f;)V
