...
.method private isViewCreateByAdapter(Landroidx/recyclerview/widget/RecyclerView$g0;)Z
    .locals 1
...
.method public clearView(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-direct {p0, p2}, Lcom/chad/library/adapter/base/callback/ItemDragAndSwipeCallback;->isViewCreateByAdapter(Landroidx/recyclerview/widget/RecyclerView$g0;)Z
    ...
    invoke-virtual {p1, p2}, Lcom/chad/library/adapter/base/BaseItemDraggableAdapter;->onItemDragEnd(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-interface {p1, p2}, Lcom/chad/library/adapter/base/listener/IDraggableListener;->onItemDragEnd(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-virtual {p1, p2}, Lcom/chad/library/adapter/base/BaseItemDraggableAdapter;->onItemSwipeClear(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-interface {p1, p2}, Lcom/chad/library/adapter/base/listener/IDraggableListener;->onItemSwipeClear(Landroidx/recyclerview/widget/RecyclerView$g0;)V
...
.method public getMovementFlags(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$g0;)I
    ...
    invoke-static {p1, p1}, Landroidx/recyclerview/widget/o$f;->makeMovementFlags(II)I
...
.method public onChildDrawOver(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$g0;FFIZ)V
    ...
    invoke-super/range {p0 .. p7}, Landroidx/recyclerview/widget/o$f;->onChildDrawOver(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$g0;FFIZ)V

    const/4 p2, 0x1

    if-ne p6, p2, :cond_3

    invoke-direct {p0, p3}, Lcom/chad/library/adapter/base/callback/ItemDragAndSwipeCallback;->isViewCreateByAdapter(Landroidx/recyclerview/widget/RecyclerView$g0;)Z

    move-result p2

    if-nez p2, :cond_3

    iget-object p2, p3, Landroidx/recyclerview/widget/RecyclerView$g0;->itemView:Landroid/view/View;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/chad/library/adapter/base/BaseItemDraggableAdapter;->onItemSwiping(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView$g0;FFZ)V
    ...
    invoke-interface/range {v1 .. v6}, Lcom/chad/library/adapter/base/listener/IDraggableListener;->onItemSwiping(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView$g0;FFZ)V
...
.method public onMove(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$g0;Landroidx/recyclerview/widget/RecyclerView$g0;)Z
    ...
    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$g0;->getItemViewType()I

    move-result p1

    invoke-virtual {p3}, Landroidx/recyclerview/widget/RecyclerView$g0;->getItemViewType()I
...
.method public onMoved(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$g0;ILandroidx/recyclerview/widget/RecyclerView$g0;III)V
    ...
    invoke-super/range {p0 .. p7}, Landroidx/recyclerview/widget/o$f;->onMoved(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$g0;ILandroidx/recyclerview/widget/RecyclerView$g0;III)V

    iget-object p1, p0, Lcom/chad/library/adapter/base/callback/ItemDragAndSwipeCallback;->mBaseItemDraggableAdapter:Lcom/chad/library/adapter/base/BaseItemDraggableAdapter;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2, p4}, Lcom/chad/library/adapter/base/BaseItemDraggableAdapter;->onItemDragMoving(Landroidx/recyclerview/widget/RecyclerView$g0;Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-interface {p1, p2, p4}, Lcom/chad/library/adapter/base/listener/IDraggableListener;->onItemDragMoving(Landroidx/recyclerview/widget/RecyclerView$g0;Landroidx/recyclerview/widget/RecyclerView$g0;)V
...
.method public onSelectedChanged(Landroidx/recyclerview/widget/RecyclerView$g0;I)V
    ...
    invoke-direct {p0, p1}, Lcom/chad/library/adapter/base/callback/ItemDragAndSwipeCallback;->isViewCreateByAdapter(Landroidx/recyclerview/widget/RecyclerView$g0;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/chad/library/adapter/base/BaseItemDraggableAdapter;->onItemDragStart(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-interface {v0, p1}, Lcom/chad/library/adapter/base/listener/IDraggableListener;->onItemDragStart(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-virtual {v0, p1}, Lcom/chad/library/adapter/base/BaseItemDraggableAdapter;->onItemSwipeStart(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-interface {v0, p1}, Lcom/chad/library/adapter/base/listener/IDraggableListener;->onItemSwipeStart(Landroidx/recyclerview/widget/RecyclerView$g0;)V
...
.method public onSwiped(Landroidx/recyclerview/widget/RecyclerView$g0;I)V
    ...
    invoke-virtual {p2, p1}, Lcom/chad/library/adapter/base/BaseItemDraggableAdapter;->onItemSwiped(Landroidx/recyclerview/widget/RecyclerView$g0;)V
    ...
    invoke-interface {p2, p1}, Lcom/chad/library/adapter/base/listener/IDraggableListener;->onItemSwiped(Landroidx/recyclerview/widget/RecyclerView$g0;)V
