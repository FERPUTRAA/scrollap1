.class public Landroidx/core/graphics/l0$b;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroidx/core/graphics/l0;
.end annotation
...
.method constructor <init>(C[F)V
    ...
    iput-char p1, p0, Landroidx/core/graphics/l0$b;->a:C

    iput-object p2, p0, Landroidx/core/graphics/l0$b;->b:[F
...
.method constructor <init>(Landroidx/core/graphics/l0$b;)V
    ...
    iget-char v0, p1, Landroidx/core/graphics/l0$b;->a:C

    iput-char v0, p0, Landroidx/core/graphics/l0$b;->a:C

    iget-object p1, p1, Landroidx/core/graphics/l0$b;->b:[F

    const/4 v0, 0x0

    array-length v1, p1

    invoke-static {p1, v0, v1}, Landroidx/core/graphics/l0;->c([FII)[F

    move-result-object p1

    iput-object p1, p0, Landroidx/core/graphics/l0$b;->b:[F
...
.method private static a(Landroid/graphics/Path;[FCC[F)V
    ...
    invoke-static/range {v0 .. v9}, Landroidx/core/graphics/l0$b;->c(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method private static c(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v6 .. v24}, Landroidx/core/graphics/l0$b;->b(Landroid/graphics/Path;DDDDDDDDD)V

    return-void
.end method

.method public static e([Landroidx/core/graphics/l0$b;Landroid/graphics/Path;)V
    .locals 5
    ...
    iget-char v4, v3, Landroidx/core/graphics/l0$b;->a:C

    iget-object v3, v3, Landroidx/core/graphics/l0$b;->b:[F

    invoke-static {p1, v0, v1, v4, v3}, Landroidx/core/graphics/l0$b;->a(Landroid/graphics/Path;[FCC[F)V

    aget-object v1, p0, v2

    iget-char v1, v1, Landroidx/core/graphics/l0$b;->a:C
...
# virtual methods
.method public d(Landroidx/core/graphics/l0$b;Landroidx/core/graphics/l0$b;F)V
    .locals 4
    ...
    :goto_0
    iget-object v1, p1, Landroidx/core/graphics/l0$b;->b:[F

    array-length v2, v1

    if-ge v0, v2, :cond_0

    iget-object v2, p0, Landroidx/core/graphics/l0$b;->b:[F
    ...
    iget-object v3, p2, Landroidx/core/graphics/l0$b;->b:[F
