...
.method public static final d(Landroid/util/SparseIntArray;Lo8/p;)V
    .locals 4
    .param p0    # Landroid/util/SparseIntArray;
        .annotation build Loa/d;
        .end annotation
...
.method public static final f(Landroid/util/SparseIntArray;ILo8/a;)I
    .locals 1
    .param p0    # Landroid/util/SparseIntArray;
        .annotation build Loa/d;
        .end annotation
...
.method public static final j(Landroid/util/SparseIntArray;)Lkotlin/collections/s0;
    .locals 1
    .param p0    # Landroid/util/SparseIntArray;
        .annotation build Loa/d;
        .end annotation
    ...
    new-instance v0, Landroidx/core/util/x$a;

    invoke-direct {v0, p0}, Landroidx/core/util/x$a;-><init>(Landroid/util/SparseIntArray;)V
...
.method public static final k(Landroid/util/SparseIntArray;Landroid/util/SparseIntArray;)Landroid/util/SparseIntArray;
    ...
    invoke-static {v0, p0}, Landroidx/core/util/x;->l(Landroid/util/SparseIntArray;Landroid/util/SparseIntArray;)V

    invoke-static {v0, p1}, Landroidx/core/util/x;->l(Landroid/util/SparseIntArray;Landroid/util/SparseIntArray;)V
...
.method public static final o(Landroid/util/SparseIntArray;)Lkotlin/collections/s0;
    .locals 1
    .param p0    # Landroid/util/SparseIntArray;
        .annotation build Loa/d;
        .end annotation
    ...
    new-instance v0, Landroidx/core/util/x$b;

    invoke-direct {v0, p0}, Landroidx/core/util/x$b;-><init>(Landroid/util/SparseIntArray;)V
