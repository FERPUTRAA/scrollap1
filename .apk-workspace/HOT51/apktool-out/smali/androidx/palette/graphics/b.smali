...
.field static final l:Landroidx/palette/graphics/b$c;
...
.method private D(Landroidx/palette/graphics/b$e;Landroidx/palette/graphics/d;)Z
    .locals 5
    ...
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->e()F
    ...
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->c()F
    ...
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->d()F
    ...
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->b()F
...
.method private i(Landroidx/palette/graphics/b$e;Landroidx/palette/graphics/d;)F
    .locals 7
    ...
    :goto_0
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->g()F
    ...
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->i()F
    ...
    :goto_1
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->a()F
    ...
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->h()F
    ...
    :goto_2
    invoke-virtual {p2}, Landroidx/palette/graphics/d;->f()F
...
.method private j(Landroidx/palette/graphics/d;)Landroidx/palette/graphics/b$e;
    .locals 3
    .annotation build Landroidx/annotation/q0;
    .end annotation

    invoke-direct {p0, p1}, Landroidx/palette/graphics/b;->v(Landroidx/palette/graphics/d;)Landroidx/palette/graphics/b$e;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Landroidx/palette/graphics/d;->j()Z
...
.method private v(Landroidx/palette/graphics/d;)Landroidx/palette/graphics/b$e;
    .locals 7
    .annotation build Landroidx/annotation/q0;
    .end annotation
    ...
    invoke-direct {p0, v4, p1}, Landroidx/palette/graphics/b;->D(Landroidx/palette/graphics/b$e;Landroidx/palette/graphics/d;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-direct {p0, v4, p1}, Landroidx/palette/graphics/b;->i(Landroidx/palette/graphics/b$e;Landroidx/palette/graphics/d;)F
...
.method public B(I)I
    ...
    sget-object v0, Landroidx/palette/graphics/d;->z:Landroidx/palette/graphics/d;

    invoke-virtual {p0, v0, p1}, Landroidx/palette/graphics/b;->k(Landroidx/palette/graphics/d;I)I
...
.method public C()Landroidx/palette/graphics/b$e;
    ...
    invoke-virtual {p0, v0}, Landroidx/palette/graphics/b;->y(Landroidx/palette/graphics/d;)Landroidx/palette/graphics/b$e;
...
.method f()V
    ...
    check-cast v2, Landroidx/palette/graphics/d;

    invoke-virtual {v2}, Landroidx/palette/graphics/d;->k()V

    iget-object v3, p0, Landroidx/palette/graphics/b;->c:Ljava/util/Map;

    invoke-direct {p0, v2}, Landroidx/palette/graphics/b;->j(Landroidx/palette/graphics/d;)Landroidx/palette/graphics/b$e;
...
.method public k(Landroidx/palette/graphics/d;I)I
    .locals 0
...
.method public l(I)I
    ...
    sget-object v0, Landroidx/palette/graphics/d;->D:Landroidx/palette/graphics/d;
...
.method public n(I)I
    ...
    sget-object v0, Landroidx/palette/graphics/d;->A:Landroidx/palette/graphics/d;
...
.method public r(I)I
    ...
    sget-object v0, Landroidx/palette/graphics/d;->B:Landroidx/palette/graphics/d;
...
.method public t(I)I
    ...
    sget-object v0, Landroidx/palette/graphics/d;->y:Landroidx/palette/graphics/d;
...
.method public w(I)I
    ...
    sget-object v0, Landroidx/palette/graphics/d;->C:Landroidx/palette/graphics/d;
...
.method public y(Landroidx/palette/graphics/d;)Landroidx/palette/graphics/b$e;
    .locals 1
    .param p1    # Landroidx/palette/graphics/d;
        .annotation build Landroidx/annotation/o0;
        .end annotation
