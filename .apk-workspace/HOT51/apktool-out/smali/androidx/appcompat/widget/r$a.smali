...
# interfaces
.implements Landroidx/appcompat/widget/z1$f;


# annotations
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/appcompat/widget/r;->i()V
.end annotation
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/r$a;->a:[I
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/r$a;->b:[I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/r$a;->c:[I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/r$a;->d:[I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/r$a;->e:[I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/r$a;->f:[I
...
.method private g(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/appcompat/widget/r$a;->h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/i2;->d(Landroid/content/Context;I)I

    move-result v2

    sget v3, Landroidx/appcompat/R$attr;->colorButtonNormal:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/i2;->c(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/i2;->c:[I
    ...
    invoke-static {v2, p2}, Landroidx/core/graphics/b0;->t(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Landroidx/appcompat/widget/i2;->d:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/i2;->j:[I
...
.method private i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/i2;->d(Landroid/content/Context;I)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/i2;->f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v2, Landroidx/appcompat/widget/i2;->c:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/i2;->g:[I
    ...
    sget-object v3, Landroidx/appcompat/widget/i2;->g:[I

    aput-object v3, v1, v5

    sget v3, Landroidx/appcompat/R$attr;->colorControlActivated:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/i2;->d(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v5

    sget-object v3, Landroidx/appcompat/widget/i2;->j:[I
...
.method private l(Landroidx/appcompat/widget/z1;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    .param p1    # Landroidx/appcompat/widget/z1;
        .annotation build Landroidx/annotation/o0;
        .end annotation
    .end param
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/z1;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Landroidx/appcompat/R$drawable;->abc_star_half_black_48dp:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/z1;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/e1;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {}, Landroidx/appcompat/widget/r;->a()Landroid/graphics/PorterDuff$Mode;

    move-result-object p3

    :cond_1
    invoke-static {p2, p3}, Landroidx/appcompat/widget/r;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
# virtual methods
.method public a(Landroidx/appcompat/widget/z1;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 3
    .param p1    # Landroidx/appcompat/widget/z1;
        .annotation build Landroidx/annotation/o0;
        .end annotation
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/r$a;->l(Landroidx/appcompat/widget/z1;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/r$a;->k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/r$a;->j(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/r$a;->g(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/r$a;->i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :cond_6
    iget-object v0, p0, Landroidx/appcompat/widget/r$a;->b:[I

    invoke-direct {p0, v0, p2}, Landroidx/appcompat/widget/r$a;->f([II)Z
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/i2;->f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_7
    iget-object v0, p0, Landroidx/appcompat/widget/r$a;->e:[I
    ...
    :cond_8
    iget-object v0, p0, Landroidx/appcompat/widget/r$a;->f:[I
...
.method public c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/r$a;->a:[I

    invoke-direct {p0, v1, p2}, Landroidx/appcompat/widget/r$a;->f([II)Z
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/widget/r$a;->c:[I
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/r$a;->d:[I
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/e1;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p1, p2}, Landroidx/appcompat/widget/i2;->d(Landroid/content/Context;I)I

    move-result p1

    invoke-static {p1, v1}, Landroidx/appcompat/widget/r;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-direct {p0, p2, v4, v5}, Landroidx/appcompat/widget/r$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-direct {p0, p2, v0, v3}, Landroidx/appcompat/widget/r$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/i2;->d(Landroid/content/Context;I)I
    ...
    invoke-direct {p0, p2, p1, p3}, Landroidx/appcompat/widget/r$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-direct {p0, p2, v0, v4}, Landroidx/appcompat/widget/r$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-direct {p0, p2, v3, v4}, Landroidx/appcompat/widget/r$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
