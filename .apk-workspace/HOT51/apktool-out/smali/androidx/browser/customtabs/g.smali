...
.method constructor <init>(Landroid/support/customtabs/ICustomTabsService;Landroid/support/customtabs/ICustomTabsCallback;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    iput-object p1, p0, Landroidx/browser/customtabs/g;->b:Landroid/support/customtabs/ICustomTabsService;

    iput-object p2, p0, Landroidx/browser/customtabs/g;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public static c(Landroid/content/ComponentName;)Landroidx/browser/customtabs/g;
    ...
    invoke-direct {v0, v1, v2, p0, v3}, Landroidx/browser/customtabs/g;-><init>(Landroid/support/customtabs/ICustomTabsService;Landroid/support/customtabs/ICustomTabsCallback;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method d()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Landroidx/browser/customtabs/g;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public g(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/g;->b:Landroid/support/customtabs/ICustomTabsService;

    iget-object v1, p0, Landroidx/browser/customtabs/g;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public h(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/browser/customtabs/g;->b:Landroid/support/customtabs/ICustomTabsService;

    iget-object v2, p0, Landroidx/browser/customtabs/g;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public k(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object p2, p0, Landroidx/browser/customtabs/g;->b:Landroid/support/customtabs/ICustomTabsService;
...
.method public l(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    :try_start_0
    iget-object p1, p0, Landroidx/browser/customtabs/g;->b:Landroid/support/customtabs/ICustomTabsService;

    iget-object p2, p0, Landroidx/browser/customtabs/g;->c:Landroid/support/customtabs/ICustomTabsCallback;
...
.method public m(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    iget-object p3, p0, Landroidx/browser/customtabs/g;->c:Landroid/support/customtabs/ICustomTabsCallback;
