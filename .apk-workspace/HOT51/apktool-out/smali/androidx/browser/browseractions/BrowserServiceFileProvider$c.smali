...
.field private final e:Landroidx/concurrent/futures/e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/graphics/Bitmap;Landroid/net/Uri;Landroidx/concurrent/futures/e;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p5, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$c;->e:Landroidx/concurrent/futures/e;
...
.method private c(Ljava/io/File;)V
    ...
    :try_start_0
    invoke-virtual {v0}, Landroidx/core/util/a;->h()Ljava/io/FileOutputStream;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/util/a;->c(Ljava/io/FileOutputStream;)V

    iget-object v1, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$c;->e:Landroidx/concurrent/futures/e;

    iget-object v2, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$c;->d:Landroid/net/Uri;

    invoke-virtual {v1, v2}, Landroidx/concurrent/futures/e;->r(Ljava/lang/Object;)Z
    :try_end_1
    ...
    :goto_0
    invoke-virtual {v0, p1}, Landroidx/core/util/a;->b(Ljava/io/FileOutputStream;)V

    iget-object p1, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$c;->e:Landroidx/concurrent/futures/e;

    invoke-virtual {p1, v1}, Landroidx/concurrent/futures/e;->s(Ljava/lang/Throwable;)Z
...
.method private d()V
    ...
    sget-object v1, Landroidx/browser/browseractions/BrowserServiceFileProvider;->y:Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroidx/browser/browseractions/BrowserServiceFileProvider$c;->e:Landroidx/concurrent/futures/e;
    ...
    invoke-virtual {v0, v2}, Landroidx/concurrent/futures/e;->s(Ljava/lang/Throwable;)Z
