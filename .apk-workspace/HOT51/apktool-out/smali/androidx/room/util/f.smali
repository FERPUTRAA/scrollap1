...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/room/util/f$c;,
        Landroidx/room/util/f$b;,
...
# static fields
.field public static final e:Landroidx/room/util/f$b;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Landroidx/room/util/f$b;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Landroidx/room/util/f$b;-><init>(Lkotlin/jvm/internal/w;)V

    sput-object v0, Landroidx/room/util/f;->e:Landroidx/room/util/f$b;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/room/util/f;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V
...
.method public synthetic constructor <init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;ILkotlin/jvm/internal/w;)V
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/util/f;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V

    return-void
.end method

.method public static final a(Ll0/e;Ljava/lang/String;)Landroidx/room/util/f;
    .locals 1
    .param p0    # Ll0/e;
        .annotation build Loa/d;
        .end annotation
    ...
    sget-object v0, Landroidx/room/util/f;->e:Landroidx/room/util/f$b;

    invoke-virtual {v0, p0, p1}, Landroidx/room/util/f$b;->a(Ll0/e;Ljava/lang/String;)Landroidx/room/util/f;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Landroidx/room/util/f;->a:Ljava/lang/String;
