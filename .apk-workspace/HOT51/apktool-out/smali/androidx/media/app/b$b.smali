.class public Landroidx/media/app/b$b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/media/app/b$b;->e:[I
...
.method private D(Landroidx/core/app/x1$b;)Landroid/widget/RemoteViews;
    .locals 4
    ...
    invoke-virtual {p1}, Landroidx/core/app/x1$b;->e()I
...
.method A(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    iget-object v0, p0, Landroidx/media/app/b$b;->e:[I
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media/app/b$b;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method B()Landroid/widget/RemoteViews;
    ...
    iget-object v0, v0, Landroidx/core/app/x1$g;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Landroidx/media/app/b$b;->E(I)I

    move-result v1

    const/4 v2, 0x0

    invoke-virtual {p0, v2, v1, v2}, Landroidx/core/app/x1$q;->c(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object v4, v4, Landroidx/core/app/x1$g;->b:Ljava/util/ArrayList;

    invoke-virtual {v4, v3}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroidx/core/app/x1$b;

    invoke-direct {p0, v4}, Landroidx/media/app/b$b;->D(Landroidx/core/app/x1$b;)Landroid/widget/RemoteViews;
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/media/app/b$b;->g:Z
    ...
    iget-object v2, p0, Landroidx/media/app/b$b;->h:Landroid/app/PendingIntent;
...
.method C()Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p0}, Landroidx/media/app/b$b;->F()I
    ...
    iget-object v4, p0, Landroidx/media/app/b$b;->e:[I
    ...
    iget-object v6, p0, Landroidx/core/app/x1$q;->a:Landroidx/core/app/x1$g;

    iget-object v6, v6, Landroidx/core/app/x1$g;->b:Ljava/util/ArrayList;

    iget-object v7, p0, Landroidx/media/app/b$b;->e:[I
    ...
    check-cast v6, Landroidx/core/app/x1$b;

    invoke-direct {p0, v6}, Landroidx/media/app/b$b;->D(Landroidx/core/app/x1$b;)Landroid/widget/RemoteViews;
    ...
    :cond_2
    iget-boolean v2, p0, Landroidx/media/app/b$b;->g:Z
    ...
    iget-object v1, p0, Landroidx/media/app/b$b;->h:Landroid/app/PendingIntent;
...
.method public H(Landroid/app/PendingIntent;)Landroidx/media/app/b$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/app/b$b;->h:Landroid/app/PendingIntent;

    return-object p0
.end method

.method public I(Landroid/support/v4/media/session/MediaSessionCompat$Token;)Landroidx/media/app/b$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/app/b$b;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    return-object p0
.end method

.method public varargs J([I)Landroidx/media/app/b$b;
    .locals 0

    iput-object p1, p0, Landroidx/media/app/b$b;->e:[I

    return-object p0
.end method

.method public K(Z)Landroidx/media/app/b$b;
    .locals 0
