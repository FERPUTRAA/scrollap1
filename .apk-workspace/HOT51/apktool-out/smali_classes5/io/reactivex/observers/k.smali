...
.method public constructor <init>(Lio/reactivex/d0;)V
    ...
    iput-object p1, p0, Lio/reactivex/observers/k;->a:Lio/reactivex/d0;
...
.method a()V
    ...
    :try_start_0
    iget-object v4, p0, Lio/reactivex/observers/k;->a:Lio/reactivex/d0;

    sget-object v5, Lio/reactivex/internal/disposables/e;->a:Lio/reactivex/internal/disposables/e;

    invoke-interface {v4, v5}, Lio/reactivex/d0;->d(Lio/reactivex/disposables/c;)V
    :try_end_0
    ...
    invoke-interface {v4, v0}, Lio/reactivex/d0;->onError(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    invoke-static {v5}, Lio/reactivex/plugins/a;->V(Ljava/lang/Throwable;)V
...
.method public b()Z
    ...
    iget-object v0, p0, Lio/reactivex/observers/k;->b:Lio/reactivex/disposables/c;
...
.method c()V
    ...
    invoke-interface {v4, v1}, Lio/reactivex/d0;->onError(Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public d(Lio/reactivex/disposables/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/observers/k;->b:Lio/reactivex/disposables/c;

    :try_start_0
    iget-object v0, p0, Lio/reactivex/observers/k;->a:Lio/reactivex/d0;
...
.method public f(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v3, p0, Lio/reactivex/observers/k;->b:Lio/reactivex/disposables/c;
    ...
    invoke-direct {v4, v2}, Lio/reactivex/exceptions/a;-><init>([Ljava/lang/Throwable;)V
    ...
    :cond_2
    :try_start_1
    iget-object v3, p0, Lio/reactivex/observers/k;->a:Lio/reactivex/d0;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Lio/reactivex/observers/k;->b:Lio/reactivex/disposables/c;
    ...
    :try_start_0
    iget-object v5, p0, Lio/reactivex/observers/k;->a:Lio/reactivex/d0;

    sget-object v6, Lio/reactivex/internal/disposables/e;->a:Lio/reactivex/internal/disposables/e;

    invoke-interface {v5, v6}, Lio/reactivex/d0;->d(Lio/reactivex/disposables/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    invoke-interface {v5, v6}, Lio/reactivex/d0;->onError(Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-direct {v6, v4}, Lio/reactivex/exceptions/a;-><init>([Ljava/lang/Throwable;)V

    invoke-static {v6}, Lio/reactivex/plugins/a;->V(Ljava/lang/Throwable;)V
    ...
    :cond_2
    :try_start_2
    iget-object v1, p0, Lio/reactivex/observers/k;->a:Lio/reactivex/d0;

    invoke-interface {v1, p1}, Lio/reactivex/d0;->onError(Ljava/lang/Throwable;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2
    ...
    invoke-direct {v4, v3}, Lio/reactivex/exceptions/a;-><init>([Ljava/lang/Throwable;)V
