...
# direct methods
.method public constructor <init>(Lio/reactivex/b0;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/e0;Ljava/util/concurrent/Callable;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/q;->e:Lio/reactivex/e0;
...
.method protected i5(Lio/reactivex/d0;)V
    ...
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/q;->e:Lio/reactivex/e0;

    move-object v1, v8

    invoke-direct/range {v1 .. v7}, Lio/reactivex/internal/operators/observable/q$b;-><init>(Lio/reactivex/d0;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/e0;)V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/q;->e:Lio/reactivex/e0;
    ...
    invoke-direct/range {v1 .. v9}, Lio/reactivex/internal/operators/observable/q$a;-><init>(Lio/reactivex/d0;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;IZLio/reactivex/e0$c;)V

    invoke-interface {v0, v10}, Lio/reactivex/b0;->a(Lio/reactivex/d0;)V
    ...
    invoke-direct/range {v1 .. v9}, Lio/reactivex/internal/operators/observable/q$c;-><init>(Lio/reactivex/d0;Ljava/util/concurrent/Callable;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/e0$c;)V
