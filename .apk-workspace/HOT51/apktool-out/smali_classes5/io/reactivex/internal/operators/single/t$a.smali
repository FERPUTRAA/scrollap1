...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/reactivex/internal/operators/single/t$a$a;
    }
.end annotation
...
# direct methods
.method constructor <init>(Lio/reactivex/h0;Lz7/o;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/single/t$a;->actual:Lio/reactivex/h0;

    iput-object p2, p0, Lio/reactivex/internal/operators/single/t$a;->mapper:Lz7/o;
...
.method public d(Lio/reactivex/disposables/c;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/single/t$a;->actual:Lio/reactivex/h0;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/single/t$a;->actual:Lio/reactivex/h0;
...
.method public onSuccess(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/single/t$a;->mapper:Lz7/o;
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/single/t$a;->b()Z

    move-result v0

    if-nez v0, :cond_0

    new-instance v0, Lio/reactivex/internal/operators/single/t$a$a;

    iget-object v1, p0, Lio/reactivex/internal/operators/single/t$a;->actual:Lio/reactivex/h0;

    invoke-direct {v0, p0, v1}, Lio/reactivex/internal/operators/single/t$a$a;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/h0;)V
