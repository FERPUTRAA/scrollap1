...
.field final N:Lio/reactivex/e0;
...
# direct methods
.method constructor <init>(Lio/reactivex/d0;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/e0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/q$b;->Q:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/q$b;->K:Ljava/util/concurrent/Callable;

    iput-wide p3, p0, Lio/reactivex/internal/operators/observable/q$b;->L:J

    iput-object p5, p0, Lio/reactivex/internal/operators/observable/q$b;->M:Ljava/util/concurrent/TimeUnit;

    iput-object p6, p0, Lio/reactivex/internal/operators/observable/q$b;->N:Lio/reactivex/e0;
...
.method public b()Z
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/q$b;->Q:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public d(Lio/reactivex/disposables/c;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/q$b;->O:Lio/reactivex/disposables/c;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/q$b;->O:Lio/reactivex/disposables/c;

    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/q$b;->K:Ljava/util/concurrent/Callable;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/q$b;->P:Ljava/util/Collection;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/q$b;->N:Lio/reactivex/e0;

    iget-wide v4, p0, Lio/reactivex/internal/operators/observable/q$b;->L:J

    iget-object v6, p0, Lio/reactivex/internal/operators/observable/q$b;->M:Ljava/util/concurrent/TimeUnit;
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/q$b;->e()V

    iget-object v0, p0, Lio/reactivex/internal/observers/w;->F:Lio/reactivex/d0;

    invoke-static {p1, v0}, Lio/reactivex/internal/disposables/e;->j(Ljava/lang/Throwable;Lio/reactivex/d0;)V
...
.method public f(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/q$b;->P:Ljava/util/Collection;
...
.method public bridge synthetic k(Lio/reactivex/d0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/observable/q$b;->o(Lio/reactivex/d0;Ljava/util/Collection;)V
...
.method public onComplete()V
    ...
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/q$b;->P:Ljava/util/Collection;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    :try_start_0
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/q$b;->P:Ljava/util/Collection;
...
.method public run()V
    ...
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/q$b;->P:Ljava/util/Collection;
    ...
    invoke-virtual {p0, v1, v0, p0}, Lio/reactivex/internal/observers/w;->m(Ljava/lang/Object;ZLio/reactivex/disposables/c;)V
