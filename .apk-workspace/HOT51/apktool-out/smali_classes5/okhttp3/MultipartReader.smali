...
.field private static final afterBoundaryOptions:Lokio/s0;
    .annotation build Loa/d;
    .end annotation
.end field
...
.field private final crlfDashDashBoundary:Lokio/m;
    .annotation build Loa/d;
    .end annotation
.end field
...
.field private final dashDashBoundary:Lokio/m;
    .annotation build Loa/d;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    new-array v1, v1, [Lokio/m;

    sget-object v2, Lokio/m;->c:Lokio/m$a;

    const-string v3, "\r\n"

    invoke-virtual {v2, v3}, Lokio/m$a;->l(Ljava/lang/String;)Lokio/m;
    ...
    invoke-virtual {v0, v1}, Lokio/s0$a;->d([Lokio/m;)Lokio/s0;

    move-result-object v0

    sput-object v0, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/s0;
...
.method public constructor <init>(Lokio/l;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p2}, Lokio/j;->X1(Ljava/lang/String;)Lokio/j;

    move-result-object p1

    invoke-virtual {p1}, Lokio/j;->R1()Lokio/m;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/MultipartReader;->dashDashBoundary:Lokio/m;
    ...
    iput-object p1, p0, Lokhttp3/MultipartReader;->crlfDashDashBoundary:Lokio/m;
...
.method public static final synthetic access$getAfterBoundaryOptions$cp()Lokio/s0;
    .locals 1

    sget-object v0, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/s0;
...
.method private final currentPartBytesRemaining(J)J
    ...
    iget-object v1, p0, Lokhttp3/MultipartReader;->crlfDashDashBoundary:Lokio/m;
    ...
    invoke-interface {v0, v1, v2}, Lokio/l;->L0(J)V
    ...
    invoke-virtual {v0, v1}, Lokio/j;->G(Lokio/m;)J
    ...
    iget-object v2, p0, Lokhttp3/MultipartReader;->crlfDashDashBoundary:Lokio/m;
...
.method public final nextPart()Lokhttp3/MultipartReader$Part;
    ...
    iget-object v5, p0, Lokhttp3/MultipartReader;->dashDashBoundary:Lokio/m;

    invoke-interface {v0, v3, v4, v5}, Lokio/l;->i0(JLokio/m;)Z
    ...
    iget-object v3, p0, Lokhttp3/MultipartReader;->dashDashBoundary:Lokio/m;
    ...
    iget-object v3, p0, Lokhttp3/MultipartReader;->crlfDashDashBoundary:Lokio/m;
    ...
    sget-object v4, Lokhttp3/MultipartReader;->afterBoundaryOptions:Lokio/s0;

    invoke-interface {v3, v4}, Lokio/l;->x2(Lokio/s0;)I
    ...
    invoke-static {v1}, Lokio/p0;->e(Lokio/e1;)Lokio/l;
