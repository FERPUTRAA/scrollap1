...
.method public static final sha1Hash(Ljava/security/cert/X509Certificate;)Lokio/m;
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Lokio/m;
...
.method public static final sha256Hash(Ljava/security/cert/X509Certificate;)Lokio/m;
    .locals 1
    .param p0    # Ljava/security/cert/X509Certificate;
        .annotation build Loa/d;
        .end annotation
    ...
    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Lokio/m;
...
.method public final check(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v0}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lo8/a;)V
...
.method public final check$okhttp(Ljava/lang/String;Lo8/a;)V
    .locals 9
    .param p1    # Ljava/lang/String;
        .annotation build Loa/d;
        .end annotation
    ...
    invoke-virtual {v4, v2}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Lokio/m;

    move-result-object v4

    :cond_3
    invoke-virtual {v6}, Lokhttp3/CertificatePinner$Pin;->getHash()Lokio/m;
    ...
    invoke-virtual {v5, v2}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Lokio/m;
