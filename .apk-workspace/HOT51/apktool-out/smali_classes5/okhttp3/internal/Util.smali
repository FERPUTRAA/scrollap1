...
.field private static final UNICODE_BOMS:Lokio/s0;
    .annotation build Loa/d;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lokio/s0;->d:Lokio/s0$a;

    const/4 v2, 0x5

    new-array v2, v2, [Lokio/m;

    sget-object v3, Lokio/m;->c:Lokio/m$a;

    const-string v4, "efbbbf"

    invoke-virtual {v3, v4}, Lokio/m$a;->i(Ljava/lang/String;)Lokio/m;
    ...
    invoke-virtual {v1, v2}, Lokio/s0$a;->d([Lokio/m;)Lokio/s0;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/s0;
...
.method public static final asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;
    ...
    invoke-direct {v0, p0}, Lh9/b;-><init>(Lokhttp3/EventListener;)V
...
.method public static final canParseAsIpAddress(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p0}, Lkotlin/text/r;->k(Ljava/lang/CharSequence;)Z
...
.method public static final delimiterOffset(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p1, v1, v4, v2, v3}, Lkotlin/text/v;->S2(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static final discard(Lokio/e1;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    .param p0    # Lokio/e1;
        .annotation build Loa/d;
        .end annotation
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lokio/e1;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final filterList(Ljava/lang/Iterable;Lo8/l;)Ljava/util/List;
    .locals 3
...
.method public static final ignoreIoExceptions(Lo8/a;)V
    .locals 1
    .param p0    # Lo8/a;
        .annotation build Loa/d;
        .end annotation
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/c1;
...
.method public static final isHealthy(Ljava/net/Socket;Lokio/l;)Z
    ...
    invoke-interface {p1}, Lokio/l;->n1()Z
...
.method public static final readBomAsCharset(Lokio/l;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/s0;

    invoke-interface {p0, v0}, Lokio/l;->x2(Lokio/s0;)I
...
.method public static final skipAll(Lokio/j;B)I
    ...
    :goto_0
    invoke-virtual {p0}, Lokio/j;->n1()Z
...
.method public static final skipAll(Lokio/e1;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .param p0    # Lokio/e1;
        .annotation build Loa/d;
        .end annotation
    ...
    invoke-virtual {v2}, Lokio/g1;->hasDeadline()Z
    ...
    invoke-virtual {v2}, Lokio/g1;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, p1, p2}, Lokio/g1;->deadlineNanoTime(J)Lokio/g1;
    ...
    invoke-interface {p0, p1, v7, v8}, Lokio/e1;->read(Lokio/j;J)J
    ...
    invoke-virtual {p0}, Lokio/g1;->clearDeadline()Lokio/g1;
    ...
    invoke-virtual {p0, v0, v1}, Lokio/g1;->deadlineNanoTime(J)Lokio/g1;
...
.method public static final threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v0, p0, p1}, Lh9/a;-><init>(Ljava/lang/String;Z)V
...
.method public static final threadName(Ljava/lang/String;Lo8/a;)V
    .locals 2
    .param p0    # Ljava/lang/String;
        .annotation build Loa/d;
        .end annotation
...
.method public static final toHeaders(Ljava/util/List;)Lokhttp3/Headers;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component1()Lokio/m;

    move-result-object v2

    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component2()Lokio/m;
