...
.method public constructor <init>(Lokhttp3/internal/concurrent/TaskRunner;Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;JLokhttp3/internal/ws/WebSocketExtensions;J)V
    ...
    sget-object p2, Lokio/m;->c:Lokio/m$a;
    ...
    invoke-static/range {p2 .. p7}, Lokio/m$a;->p(Lokio/m$a;[BIIILjava/lang/Object;)Lokio/m;

    move-result-object p1

    invoke-virtual {p1}, Lokio/m;->d()Ljava/lang/String;
...
.method private final declared-synchronized send(Lokio/m;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILokio/m;)V
...
.method public final checkUpgradeSuccess$okhttp(Lokhttp3/Response;Lokhttp3/internal/connection/Exchange;)V
    ...
    invoke-virtual {v0}, Lokio/m;->d0()Lokio/m;
...
.method public final declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-virtual {v2, p2}, Lokio/m$a;->l(Ljava/lang/String;)Lokio/m;
    ...
    invoke-direct {v0, p1, v2, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILokio/m;J)V
...
.method public onReadMessage(Lokio/m;)V
    .locals 1
    .param p1    # Lokio/m;
        .annotation build Loa/d;
        .end annotation
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lokio/m;)V

    return-void
.end method

.method public declared-synchronized onReadPing(Lokio/m;)V
    .locals 1
    .param p1    # Lokio/m;
        .annotation build Loa/d;
        .end annotation
...
.method public declared-synchronized onReadPong(Lokio/m;)V
    .locals 1
    .param p1    # Lokio/m;
        .annotation build Loa/d;
        .end annotation
...
.method public final declared-synchronized pong(Lokio/m;)Z
    .locals 1
    .param p1    # Lokio/m;
        .annotation build Loa/d;
        .end annotation
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lokio/m;I)Z
...
.method public final writeOneFrame$okhttp()Z
    ...
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lokio/m;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Message;->getData()Lokio/m;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writeMessageFrame(ILokio/m;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Close;->getReason()Lokio/m;

    move-result-object v4

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILokio/m;)V
...
.method public final writePingFrame$okhttp()V
    ...
    :cond_3
    :try_start_3
    sget-object v1, Lokio/m;->d:Lokio/m;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lokio/m;)V
    :try_end_3
