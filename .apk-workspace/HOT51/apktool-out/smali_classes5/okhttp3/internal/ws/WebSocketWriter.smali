...
.method public constructor <init>(ZLokio/k;Ljava/util/Random;ZZJ)V
    ...
    invoke-interface {p2}, Lokio/k;->k()Lokio/j;
...
.method private final writeControlFrame(ILokio/m;)V
    .locals 5
    ...
    invoke-virtual {v1, p1}, Lokio/j;->p1(I)Lokio/j;
    ...
    invoke-virtual {p1, v1}, Lokio/j;->j1([B)Lokio/j;
    ...
    invoke-virtual {p1, p2}, Lokio/j;->d1(Lokio/m;)Lokio/j;
    ...
    invoke-virtual {p1, p2}, Lokio/j;->k0(Lokio/j$a;)Lokio/j$a;

    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/j$a;

    invoke-virtual {p1, v0, v1}, Lokio/j$a;->e(J)I
...
.method public final writeClose(ILokio/m;)V
    .locals 1
    .param p2    # Lokio/m;
        .annotation build Loa/e;
        .end annotation
    ...
    invoke-virtual {v0, p2}, Lokio/j;->d1(Lokio/m;)Lokio/j;
    ...
    :try_start_0
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/WebSocketWriter;->writeControlFrame(ILokio/m;)V
    :try_end_0
...
.method public final writeMessageFrame(ILokio/m;)V
    .locals 5
    .param p2    # Lokio/m;
        .annotation build Loa/d;
        .end annotation
    ...
    invoke-virtual {p1, p2}, Lokio/j;->G1(I)Lokio/j;
    ...
    invoke-virtual {p1, v1, v2}, Lokio/j;->C1(J)Lokio/j;
    ...
    invoke-virtual {p1, p2}, Lokio/j;->j1([B)Lokio/j;
    ...
    invoke-virtual {v0, v3}, Lokio/j;->k0(Lokio/j$a;)Lokio/j$a;

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/j$a;

    invoke-virtual {v0, p1, p2}, Lokio/j$a;->e(J)I
    ...
    invoke-interface {p1}, Lokio/k;->y()Lokio/k;
...
.method public final writePing(Lokio/m;)V
    .locals 1
    .param p1    # Lokio/m;
        .annotation build Loa/d;
        .end annotation
    ...
    invoke-direct {p0, v0, p1}, Lokhttp3/internal/ws/WebSocketWriter;->writeControlFrame(ILokio/m;)V

    return-void
.end method

.method public final writePong(Lokio/m;)V
    .locals 1
    .param p1    # Lokio/m;
        .annotation build Loa/d;
        .end annotation
