...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v0, v1, v2}, Lokio/l;->X0(J)Lokio/m;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lokio/m;)V
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-virtual {p2}, Lkotlin/ranges/j;->f()I
    ...
    invoke-virtual {p2}, Lkotlin/ranges/j;->h()I
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lokio/m;
    ...
    invoke-interface {p1, v1, v2}, Lokio/l;->X0(J)Lokio/m;
