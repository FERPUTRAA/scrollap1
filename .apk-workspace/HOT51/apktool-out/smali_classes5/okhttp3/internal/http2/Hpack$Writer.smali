...
.method public constructor <init>(ILokio/j;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLokio/j;ILkotlin/jvm/internal/w;)V
...
.method public synthetic constructor <init>(IZLokio/j;ILkotlin/jvm/internal/w;)V
    .locals 0
...
.method public final writeByteString(Lokio/m;)V
    .locals 4
    .param p1    # Lokio/m;
        .annotation build Loa/d;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lokio/m;)I
    ...
    invoke-virtual {v0, p1, v2}, Lokhttp3/internal/http2/Huffman;->encode(Lokio/m;Lokio/k;)V

    invoke-virtual {v2}, Lokio/j;->R1()Lokio/m;
...
.method public final writeHeaders(Ljava/util/List;)V
    ...
    iget-object v4, v2, Lokhttp3/internal/http2/Header;->name:Lokio/m;

    invoke-virtual {v4}, Lokio/m;->n0()Lokio/m;

    move-result-object v4

    iget-object v5, v2, Lokhttp3/internal/http2/Header;->value:Lokio/m;
    ...
    iget-object v10, v10, Lokhttp3/internal/http2/Header;->value:Lokio/m;
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Header;->value:Lokio/m;
    ...
    iget-object v12, v12, Lokhttp3/internal/http2/Header;->name:Lokio/m;
    ...
    iget-object v12, v12, Lokhttp3/internal/http2/Header;->value:Lokio/m;
    ...
    invoke-virtual {v6, v7}, Lokio/j;->p1(I)Lokio/j;

    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lokio/m;)V

    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lokio/m;)V
    ...
    :cond_a
    sget-object v8, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lokio/m;

    invoke-virtual {v4, v8}, Lokio/m;->g0(Lokio/m;)Z

    move-result v8

    if-eqz v8, :cond_b

    sget-object v8, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lokio/m;
...
.method public final writeInt(III)V
    ...
    invoke-virtual {p2, p1}, Lokio/j;->p1(I)Lokio/j;
    ...
    invoke-virtual {v0, p3}, Lokio/j;->p1(I)Lokio/j;
    ...
    invoke-virtual {v0, p2}, Lokio/j;->p1(I)Lokio/j;
