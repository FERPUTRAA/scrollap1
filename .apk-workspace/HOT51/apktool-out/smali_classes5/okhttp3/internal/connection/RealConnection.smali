...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lokio/p0;->v(Ljava/net/Socket;)Lokio/e1;
    ...
    invoke-static {v1}, Lokio/p0;->q(Ljava/net/Socket;)Lokio/c1;
    ...
    invoke-static {p4, p3}, Lkotlin/jvm/internal/l0;->C(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lo8/a;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lo8/a;)V
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-virtual {v5, v6, v7, v8}, Lokio/g1;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/g1;
    ...
    invoke-virtual {p1}, Lokio/j;->n1()Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, Lokio/e1;->timeout()Lokio/g1;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lokio/g1;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/g1;
