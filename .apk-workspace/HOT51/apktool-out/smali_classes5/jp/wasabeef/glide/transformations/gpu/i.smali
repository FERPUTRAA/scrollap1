...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v1, v2, v0}, Ljp/wasabeef/glide/transformations/gpu/i;-><init>(FFLandroid/graphics/PointF;)V
...
.method public constructor <init>(FFLandroid/graphics/PointF;)V
    ...
    iput p1, p0, Ljp/wasabeef/glide/transformations/gpu/i;->g:F

    iput p2, p0, Ljp/wasabeef/glide/transformations/gpu/i;->h:F

    iput-object p3, p0, Ljp/wasabeef/glide/transformations/gpu/i;->i:Landroid/graphics/PointF;
...
.method public b(Ljava/security/MessageDigest;)V
    ...
    iget v1, p0, Ljp/wasabeef/glide/transformations/gpu/i;->g:F

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    iget v1, p0, Ljp/wasabeef/glide/transformations/gpu/i;->h:F

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    iget-object v1, p0, Ljp/wasabeef/glide/transformations/gpu/i;->i:Landroid/graphics/PointF;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Ljp/wasabeef/glide/transformations/gpu/i;

    if-eqz v0, :cond_0

    check-cast p1, Ljp/wasabeef/glide/transformations/gpu/i;

    iget v0, p1, Ljp/wasabeef/glide/transformations/gpu/i;->g:F
    ...
    iget v0, p1, Ljp/wasabeef/glide/transformations/gpu/i;->h:F

    cmpl-float v0, v0, v1

    if-nez v0, :cond_0

    iget-object p1, p1, Ljp/wasabeef/glide/transformations/gpu/i;->i:Landroid/graphics/PointF;

    iget-object v0, p0, Ljp/wasabeef/glide/transformations/gpu/i;->i:Landroid/graphics/PointF;
...
.method public hashCode()I
    ...
    iget v0, p0, Ljp/wasabeef/glide/transformations/gpu/i;->g:F
    ...
    iget v0, p0, Ljp/wasabeef/glide/transformations/gpu/i;->h:F
