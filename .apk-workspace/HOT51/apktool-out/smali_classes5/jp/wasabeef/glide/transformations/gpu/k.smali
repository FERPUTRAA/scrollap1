...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Ljp/wasabeef/glide/transformations/gpu/k;-><init>(Landroid/graphics/PointF;[FFF)V
...
.method public constructor <init>(Landroid/graphics/PointF;[FFF)V
    ...
    iput-object p1, p0, Ljp/wasabeef/glide/transformations/gpu/k;->g:Landroid/graphics/PointF;

    iput-object p2, p0, Ljp/wasabeef/glide/transformations/gpu/k;->h:[F

    iput p3, p0, Ljp/wasabeef/glide/transformations/gpu/k;->i:F

    iput p4, p0, Ljp/wasabeef/glide/transformations/gpu/k;->j:F
...
.method public b(Ljava/security/MessageDigest;)V
    ...
    iget-object v1, p0, Ljp/wasabeef/glide/transformations/gpu/k;->g:Landroid/graphics/PointF;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Ljp/wasabeef/glide/transformations/gpu/k;->h:[F
    ...
    iget v1, p0, Ljp/wasabeef/glide/transformations/gpu/k;->i:F

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    iget v1, p0, Ljp/wasabeef/glide/transformations/gpu/k;->j:F
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Ljp/wasabeef/glide/transformations/gpu/k;

    if-eqz v0, :cond_0

    check-cast p1, Ljp/wasabeef/glide/transformations/gpu/k;

    iget-object v0, p1, Ljp/wasabeef/glide/transformations/gpu/k;->g:Landroid/graphics/PointF;
    ...
    iget-object v0, p1, Ljp/wasabeef/glide/transformations/gpu/k;->h:[F
    ...
    iget v0, p1, Ljp/wasabeef/glide/transformations/gpu/k;->i:F
    ...
    iget p1, p1, Ljp/wasabeef/glide/transformations/gpu/k;->j:F

    iget v0, p0, Ljp/wasabeef/glide/transformations/gpu/k;->j:F
...
.method public hashCode()I
    ...
    iget-object v0, p0, Ljp/wasabeef/glide/transformations/gpu/k;->g:Landroid/graphics/PointF;
    ...
    iget-object v0, p0, Ljp/wasabeef/glide/transformations/gpu/k;->h:[F
    ...
    iget v0, p0, Ljp/wasabeef/glide/transformations/gpu/k;->i:F
