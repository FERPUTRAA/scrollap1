.class public final Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;
.super Lf9/a;
.source "SourceFile"
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;",
        "Lf9/a;",
        "",
        "getCount",
...
.method public constructor <init>(Landroidx/viewpager/widget/ViewPager;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;->viewPager:Landroidx/viewpager/widget/ViewPager;

    iput-object p2, p0, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;->titles:Ljava/util/List;

    return-void
.end method

.method public static synthetic a(Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;ILandroid/view/View;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;->getTitleView$lambda$0(Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;ILandroid/view/View;)V

    return-void
.end method

.method private static final getTitleView$lambda$0(Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;ILandroid/view/View;)V
    .locals 0
    ...
    iget-object p0, p0, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;->viewPager:Landroidx/viewpager/widget/ViewPager;
...
.method public getCount()I
    ...
    iget-object v0, p0, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;->titles:Ljava/util/List;
...
.method public getTitleView(Landroid/content/Context;I)Lf9/d;
    ...
    new-instance v0, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter$getTitleView$simplePagerTitleView$1;

    invoke-direct {v0, p1}, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter$getTitleView$simplePagerTitleView$1;-><init>(Landroid/content/Context;)V

    iget-object p1, p0, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;->titles:Ljava/util/List;
    ...
    new-instance p1, Lcom/example/obs/player/adapter/e;

    invoke-direct {p1, p0, p2}, Lcom/example/obs/player/adapter/e;-><init>(Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;I)V
...
.method public final getViewPager()Landroidx/viewpager/widget/ViewPager;
    ...
    iget-object v0, p0, Lcom/example/obs/player/adapter/FindPasswordNavigatorAdapter;->viewPager:Landroidx/viewpager/widget/ViewPager;
