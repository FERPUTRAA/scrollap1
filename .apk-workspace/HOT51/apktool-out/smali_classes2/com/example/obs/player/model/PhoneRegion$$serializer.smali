.class public final Lcom/example/obs/player/model/PhoneRegion$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/PhoneRegion;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/PhoneRegion.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/PhoneRegion;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/PhoneRegion$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/PhoneRegion$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/PhoneRegion$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/PhoneRegion$$serializer;->INSTANCE:Lcom/example/obs/player/model/PhoneRegion$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.PhoneRegion"
    ...
    const-string v0, "areaNumber"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    const-string v0, "mobileNumberLength"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    sput-object v1, Lcom/example/obs/player/model/PhoneRegion$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/PhoneRegion;
    .locals 19
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/PhoneRegion$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    new-instance v0, Lcom/example/obs/player/model/PhoneRegion;

    const/16 v18, 0x0

    move-object v12, v0

    invoke-direct/range {v12 .. v18}, Lcom/example/obs/player/model/PhoneRegion;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/PhoneRegion$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/PhoneRegion;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/PhoneRegion$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/PhoneRegion;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/PhoneRegion;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/PhoneRegion$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/PhoneRegion;->write$Self(Lcom/example/obs/player/model/PhoneRegion;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/PhoneRegion;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/PhoneRegion$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/PhoneRegion;)V
