.class public final Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/game/MultipleBetItem.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/game/MultipleBetItem;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;->INSTANCE:Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.game.MultipleBetItem"
    ...
    const-string v0, "fixMultiple"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    sput-object v1, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/game/MultipleBetItem;
    .locals 20
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-interface {v0, v1, v4, v9, v10}, Lkotlinx/serialization/encoding/c;->decodeNullableSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v4, v9, v15}, Lkotlinx/serialization/encoding/c;->decodeNullableSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v10 .. v19}, Lcom/example/obs/player/model/game/MultipleBetItem;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lkotlinx/serialization/json/JsonElement;Ljava/lang/String;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/game/MultipleBetItem;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/game/MultipleBetItem;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/game/MultipleBetItem;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/game/MultipleBetItem;->write$Self(Lcom/example/obs/player/model/game/MultipleBetItem;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/game/MultipleBetItem;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/game/MultipleBetItem$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/game/MultipleBetItem;)V
