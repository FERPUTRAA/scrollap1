.class public final Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/IntoRoomRefactor.ConfigInfoDTO.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.IntoRoomRefactor.ConfigInfoDTO"
    ...
    sput-object v1, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;
    .locals 10
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    new-instance p1, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;

    check-cast v1, Ljava/util/List;

    invoke-direct {p1, v3, v1, v2, v4}, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;-><init>(ILjava/util/List;Ljava/lang/String;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;->write$Self(Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/IntoRoomRefactor$ConfigInfoDTO;)V
