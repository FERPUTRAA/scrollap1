.class public final Lcom/example/obs/player/model/LiveFilterGameData$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/LiveFilterGameData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/LiveFilterGameData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/LiveFilterGameData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;->INSTANCE:Lcom/example/obs/player/model/LiveFilterGameData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.LiveFilterGameData"
    ...
    sput-object v1, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v3, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->INSTANCE:Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/LiveFilterGameData;
    .locals 21
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v12, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->INSTANCE:Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;

    invoke-direct {v10, v12}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v5, v10, v11}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v5, v8, v9}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v9 .. v19}, Lcom/example/obs/player/model/LiveFilterGameData;-><init>(IIZZIZLjava/util/List;IILkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/LiveFilterGameData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/LiveFilterGameData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/LiveFilterGameData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/LiveFilterGameData;->write$Self(Lcom/example/obs/player/model/LiveFilterGameData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/LiveFilterGameData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/LiveFilterGameData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/LiveFilterGameData;)V
