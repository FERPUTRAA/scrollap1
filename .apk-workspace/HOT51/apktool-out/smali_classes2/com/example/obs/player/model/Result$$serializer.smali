.class public final Lcom/example/obs/player/model/Result$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/Result;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/Result.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/Result;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/Result$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/Result$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/Result$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/Result$$serializer;->INSTANCE:Lcom/example/obs/player/model/Result$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.Result"
    ...
    sput-object v1, Lcom/example/obs/player/model/Result$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/Result;
    .locals 7
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/Result$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    new-instance p1, Lcom/example/obs/player/model/Result;

    const/4 v0, 0x0

    invoke-direct {p1, v2, v1, v0}, Lcom/example/obs/player/model/Result;-><init>(IZLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/Result$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/Result;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/Result$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/Result;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/Result;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/Result;->write$Self(Lcom/example/obs/player/model/Result;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/Result;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/Result$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/Result;)V
