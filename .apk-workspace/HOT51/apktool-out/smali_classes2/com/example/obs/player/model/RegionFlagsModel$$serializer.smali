.class public final Lcom/example/obs/player/model/RegionFlagsModel$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/RegionFlagsModel;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/RegionFlagsModel.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/RegionFlagsModel;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/RegionFlagsModel$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/RegionFlagsModel$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/RegionFlagsModel$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/RegionFlagsModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/RegionFlagsModel$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.RegionFlagsModel"
    ...
    sput-object v1, Lcom/example/obs/player/model/RegionFlagsModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/RegionFlagsModel;
    .locals 10
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/RegionFlagsModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-direct {v1, v5, v5}, Lkotlinx/serialization/internal/q0;-><init>(Lkotlinx/serialization/i;Lkotlinx/serialization/i;)V
    ...
    invoke-direct {v8, v9, v9}, Lkotlinx/serialization/internal/q0;-><init>(Lkotlinx/serialization/i;Lkotlinx/serialization/i;)V
    ...
    new-instance p1, Lcom/example/obs/player/model/RegionFlagsModel;

    check-cast v1, Ljava/util/Map;

    check-cast v2, Ljava/util/Map;

    invoke-direct {p1, v3, v1, v2, v4}, Lcom/example/obs/player/model/RegionFlagsModel;-><init>(ILjava/util/Map;Ljava/util/Map;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/RegionFlagsModel$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/RegionFlagsModel;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/RegionFlagsModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/RegionFlagsModel;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/RegionFlagsModel;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/RegionFlagsModel;->write$Self(Lcom/example/obs/player/model/RegionFlagsModel;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/RegionFlagsModel;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/RegionFlagsModel$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/RegionFlagsModel;)V
