.class public final Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/HomeModel.AppTopMenuDTO.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.HomeModel.AppTopMenuDTO"
    ...
    const-string v0, "menu2Enabled"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    sput-object v1, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;
    .locals 20
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-direct/range {v9 .. v17}, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;-><init>(ILjava/lang/String;Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;ZLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;->write$Self(Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;)V
