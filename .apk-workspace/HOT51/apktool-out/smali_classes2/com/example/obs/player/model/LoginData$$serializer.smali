.class public final Lcom/example/obs/player/model/LoginData$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/LoginData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/LoginData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/LoginData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/LoginData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/LoginData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/LoginData$$serializer;->INSTANCE:Lcom/example/obs/player/model/LoginData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.LoginData"
    ...
    sput-object v1, Lcom/example/obs/player/model/LoginData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/LoginData;
    .locals 36
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/LoginData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v13, Lcom/example/obs/player/model/UserCenterData$$serializer;->INSTANCE:Lcom/example/obs/player/model/UserCenterData$$serializer;

    invoke-interface {v0, v1, v3, v13, v14}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object v12, Lcom/example/obs/player/model/UserCenterData$$serializer;->INSTANCE:Lcom/example/obs/player/model/UserCenterData$$serializer;

    invoke-interface {v0, v1, v3, v12, v13}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v29, Lcom/example/obs/player/model/UserCenterData;

    const/16 v30, 0x0

    invoke-direct/range {v13 .. v30}, Lcom/example/obs/player/model/LoginData;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;JJLjava/lang/String;JLjava/lang/String;Lcom/example/obs/player/model/UserCenterData;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/LoginData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/LoginData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/LoginData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/LoginData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/LoginData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/LoginData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/LoginData;->write$Self(Lcom/example/obs/player/model/LoginData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/LoginData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/LoginData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/LoginData;)V
