.class public final Lcom/example/obs/player/model/GameReportData$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/GameReportData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/GameReportData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/GameReportData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/GameReportData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/GameReportData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/GameReportData$$serializer;->INSTANCE:Lcom/example/obs/player/model/GameReportData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.GameReportData"
    ...
    sput-object v1, Lcom/example/obs/player/model/GameReportData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v2, Lcom/example/obs/player/model/GameReportData$OrderReportDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/GameReportData$OrderReportDTO$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/GameReportData;
    .locals 18
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/GameReportData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v11, Lcom/example/obs/player/model/GameReportData$OrderReportDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/GameReportData$OrderReportDTO$$serializer;

    invoke-direct {v2, v11}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V
    ...
    invoke-direct {v9, v3}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V
    ...
    invoke-direct/range {v3 .. v12}, Lcom/example/obs/player/model/GameReportData;-><init>(ILjava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/GameReportData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/GameReportData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/GameReportData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/GameReportData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/GameReportData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/GameReportData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/GameReportData;->write$Self(Lcom/example/obs/player/model/GameReportData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/GameReportData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/GameReportData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/GameReportData;)V
