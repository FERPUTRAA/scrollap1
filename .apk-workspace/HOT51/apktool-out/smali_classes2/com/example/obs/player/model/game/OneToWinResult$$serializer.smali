.class public final Lcom/example/obs/player/model/game/OneToWinResult$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/game/OneToWinResult;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/game/OneToWinResult.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/game/OneToWinResult;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/game/OneToWinResult$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;->INSTANCE:Lcom/example/obs/player/model/game/OneToWinResult$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.game.OneToWinResult"
    ...
    sput-object v1, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/game/OneToWinResult;
    .locals 20
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    new-instance v0, Lcom/example/obs/player/model/game/OneToWinResult;

    const/16 v17, 0x0

    move-object v9, v0

    invoke-direct/range {v9 .. v17}, Lcom/example/obs/player/model/game/OneToWinResult;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/game/OneToWinResult;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/game/OneToWinResult;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/game/OneToWinResult;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/game/OneToWinResult;->write$Self(Lcom/example/obs/player/model/game/OneToWinResult;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/game/OneToWinResult;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/game/OneToWinResult$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/game/OneToWinResult;)V
