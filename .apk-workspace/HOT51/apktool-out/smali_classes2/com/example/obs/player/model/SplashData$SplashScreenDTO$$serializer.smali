.class public final Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/SplashData$SplashScreenDTO;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/SplashData.SplashScreenDTO.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/SplashData$SplashScreenDTO;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.SplashData.SplashScreenDTO"
    ...
    const-string v0, "displaySeconds"
    ...
    const-string v0, "jumpModuleSecond"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    sput-object v1, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/SplashData$SplashScreenDTO;
    .locals 22
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-direct/range {v9 .. v18}, Lcom/example/obs/player/model/SplashData$SplashScreenDTO;-><init>(IJLjava/lang/String;Ljava/lang/String;Ljava/lang/String;IILkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/SplashData$SplashScreenDTO;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/SplashData$SplashScreenDTO;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/SplashData$SplashScreenDTO;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/SplashData$SplashScreenDTO;->write$Self(Lcom/example/obs/player/model/SplashData$SplashScreenDTO;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/SplashData$SplashScreenDTO$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/SplashData$SplashScreenDTO;)V
