.class public final Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/example/obs/player/component/net/HttpUtils$getConfig$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
.end annotation
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/Object;Lo8/l;Lkotlin/coroutines/d;)V
    ...
    iput-object p1, p0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->$path:Ljava/lang/String;

    iput-object p2, p0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->$tag:Ljava/lang/Object;

    iput-object p3, p0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->$block:Lo8/l;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/d;)Lkotlin/coroutines/d;
    ...
    new-instance v0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;

    iget-object v1, p0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->$path:Ljava/lang/String;

    iget-object v2, p0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->$tag:Ljava/lang/Object;

    iget-object v3, p0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->$block:Lo8/l;

    invoke-direct {v0, v1, v2, v3, p2}, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;-><init>(Ljava/lang/String;Ljava/lang/Object;Lo8/l;Lkotlin/coroutines/d;)V

    iput-object p1, v0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->L$0:Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->invoke(Lkotlinx/coroutines/u0;Lkotlin/coroutines/d;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/u0;Lkotlin/coroutines/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->create(Ljava/lang/Object;Lkotlin/coroutines/d;)Lkotlin/coroutines/d;

    move-result-object p1

    check-cast p1, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;

    sget-object p2, Lkotlin/s2;->a:Lkotlin/s2;

    invoke-virtual {p1, p2}, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v0, p0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->label:I

    if-nez v0, :cond_3

    invoke-static {p1}, Lkotlin/e1;->n(Ljava/lang/Object;)V

    iget-object p1, p0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2;->L$0:Ljava/lang/Object;
    ...
    :try_start_0
    new-instance v0, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2$1;

    invoke-direct {v0}, Lcom/example/obs/player/component/net/HttpUtils$getConfig$2$invokeSuspend$$inlined$Post$default$2$1;-><init>()V
