.class public final Lcom/example/obs/player/model/BJHistoryModel$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/BJHistoryModel.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/BJHistoryModel;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/BJHistoryModel$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/BJHistoryModel$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/BJHistoryModel$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/BJHistoryModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/BJHistoryModel$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.BJHistoryModel"
    ...
    sput-object v1, Lcom/example/obs/player/model/BJHistoryModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v2, Lcom/example/obs/player/model/BJHistoryModel$BJGameResultDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/BJHistoryModel$BJGameResultDTO$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/BJHistoryModel;
    .locals 16
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/BJHistoryModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v8, Lcom/example/obs/player/model/BJHistoryModel$BJGameResultDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/BJHistoryModel$BJGameResultDTO$$serializer;
    ...
    sget-object v15, Lcom/example/obs/player/model/BJHistoryModel$BJGameResultDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/BJHistoryModel$BJGameResultDTO$$serializer;
    ...
    invoke-direct/range {v3 .. v12}, Lcom/example/obs/player/model/BJHistoryModel;-><init>(ILjava/util/List;DDDLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/BJHistoryModel$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/BJHistoryModel;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/BJHistoryModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/BJHistoryModel;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/BJHistoryModel;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/BJHistoryModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/BJHistoryModel;->write$Self(Lcom/example/obs/player/model/BJHistoryModel;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/BJHistoryModel;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/BJHistoryModel$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/BJHistoryModel;)V
