.class public final Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/live/GiftPackageModel.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/live/GiftPackageModel;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.live.GiftPackageModel"
    ...
    sput-object v1, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v4, Lcom/example/obs/player/model/live/GiftPackageModel$GiftItem$$serializer;->INSTANCE:Lcom/example/obs/player/model/live/GiftPackageModel$GiftItem$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/live/GiftPackageModel;
    .locals 23
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v13, Lcom/example/obs/player/model/live/GiftPackageModel$GiftItem$$serializer;->INSTANCE:Lcom/example/obs/player/model/live/GiftPackageModel$GiftItem$$serializer;

    invoke-direct {v11, v13}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v6, v11, v12}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v3, Lcom/example/obs/player/model/live/GiftPackageModel$GiftItem$$serializer;->INSTANCE:Lcom/example/obs/player/model/live/GiftPackageModel$GiftItem$$serializer;
    ...
    invoke-direct/range {v11 .. v22}, Lcom/example/obs/player/model/live/GiftPackageModel;-><init>(IILjava/lang/String;Ljava/lang/String;Ljava/util/List;ZLjava/lang/String;ILjava/lang/String;ZLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/live/GiftPackageModel;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/live/GiftPackageModel;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/live/GiftPackageModel;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/live/GiftPackageModel;->write$Self(Lcom/example/obs/player/model/live/GiftPackageModel;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/live/GiftPackageModel$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/live/GiftPackageModel;)V
