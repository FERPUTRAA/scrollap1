.class public final Lcom/example/obs/player/model/HomeModel$$serializer;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/example/obs/player/model/HomeModel;",
        ">;"
    }
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/HomeModel.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/HomeModel;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/HomeModel$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/HomeModel$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/HomeModel$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/HomeModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/HomeModel$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.HomeModel"
    ...
    const-string v0, "appTopMenuDTO"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    const-string/jumbo v0, "uploadRecordDTO"
    ...
    sput-object v1, Lcom/example/obs/player/model/HomeModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v2, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/HomeModel;
    .locals 14
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/HomeModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v7, Lcom/example/obs/player/model/HomeModel$HomeNoticeDTOS$$serializer;->INSTANCE:Lcom/example/obs/player/model/HomeModel$HomeNoticeDTOS$$serializer;

    invoke-direct {v1, v7}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V
    ...
    sget-object v5, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;
    ...
    :cond_3
    sget-object v11, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO$$serializer;
    ...
    sget-object v12, Lcom/example/obs/player/model/HomeModel$HomeNoticeDTOS$$serializer;->INSTANCE:Lcom/example/obs/player/model/HomeModel$HomeNoticeDTOS$$serializer;
    ...
    new-instance p1, Lcom/example/obs/player/model/HomeModel;
    ...
    check-cast v8, Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/example/obs/player/model/HomeModel;-><init>(ILjava/util/List;Lcom/example/obs/player/model/HomeModel$AppTopMenuDTO;Lkotlinx/serialization/json/JsonObject;Lkotlinx/serialization/json/JsonObject;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/HomeModel$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/HomeModel;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/HomeModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/HomeModel;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/HomeModel;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/HomeModel;->write$Self(Lcom/example/obs/player/model/HomeModel;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/HomeModel;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/HomeModel$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/HomeModel;)V
