.class public final Lcom/example/obs/player/model/AuditsData$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/AuditsData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/AuditsData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/AuditsData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/AuditsData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/AuditsData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/AuditsData$$serializer;->INSTANCE:Lcom/example/obs/player/model/AuditsData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.AuditsData"
    ...
    const-string v0, "noWithdrawalLimit"
    ...
    const-string/jumbo v0, "withdrawalLimit"
    ...
    sput-object v1, Lcom/example/obs/player/model/AuditsData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v4, Lcom/example/obs/player/model/AuditsData$Re$$serializer;->INSTANCE:Lcom/example/obs/player/model/AuditsData$Re$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/AuditsData;
    .locals 26
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/AuditsData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-interface {v0, v1, v5, v6, v8}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v3, Lcom/example/obs/player/model/AuditsData$Re$$serializer;->INSTANCE:Lcom/example/obs/player/model/AuditsData$Re$$serializer;

    invoke-direct {v7, v3}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v5, v7, v11}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v16 .. v25}, Lcom/example/obs/player/model/AuditsData;-><init>(IJLjava/lang/String;Ljava/util/List;JLjava/lang/String;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/AuditsData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/AuditsData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/AuditsData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/AuditsData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/AuditsData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/AuditsData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/AuditsData;->write$Self(Lcom/example/obs/player/model/AuditsData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/AuditsData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/AuditsData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/AuditsData;)V
