.class public final Lcom/example/obs/player/model/GameInfoData$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/GameInfoData;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/GameInfoData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/GameInfoData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/GameInfoData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/GameInfoData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/GameInfoData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/GameInfoData$$serializer;->INSTANCE:Lcom/example/obs/player/model/GameInfoData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.GameInfoData"
    ...
    sput-object v1, Lcom/example/obs/player/model/GameInfoData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/GameInfoData;
    .locals 24
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/GameInfoData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    :cond_3
    new-instance v7, Lkotlinx/serialization/internal/q0;

    sget-object v15, Lkotlinx/serialization/internal/z1;->a:Lkotlinx/serialization/internal/z1;

    invoke-direct {v7, v15, v15}, Lkotlinx/serialization/internal/q0;-><init>(Lkotlinx/serialization/i;Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v5, v7, v10}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v15 .. v23}, Lcom/example/obs/player/model/GameInfoData;-><init>(IJLjava/lang/String;Ljava/util/Map;Ljava/lang/String;ILkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/GameInfoData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/GameInfoData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/GameInfoData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/GameInfoData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/GameInfoData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/GameInfoData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/GameInfoData;->write$Self(Lcom/example/obs/player/model/GameInfoData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/GameInfoData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/GameInfoData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/GameInfoData;)V
