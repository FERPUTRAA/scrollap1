.class public final Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/RewardGameHistoryData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/RewardGameHistoryData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;->INSTANCE:Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.RewardGameHistoryData"
    ...
    sput-object v1, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/RewardGameHistoryData;
    .locals 23
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-direct {v12, v14}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v7, v12, v13}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v14, Lcom/example/obs/player/model/RewardGameHistoryData$Record$$serializer;->INSTANCE:Lcom/example/obs/player/model/RewardGameHistoryData$Record$$serializer;

    invoke-direct {v12, v14}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v6, v12, v13}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v3, Lcom/example/obs/player/model/RewardGameHistoryData$Record$$serializer;->INSTANCE:Lcom/example/obs/player/model/RewardGameHistoryData$Record$$serializer;

    invoke-direct {v7, v3}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v6, v7, v10}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v8 .. v20}, Lcom/example/obs/player/model/RewardGameHistoryData;-><init>(IIZZLjava/util/List;ILjava/util/List;ZIIZLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/RewardGameHistoryData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/RewardGameHistoryData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/RewardGameHistoryData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/RewardGameHistoryData;->write$Self(Lcom/example/obs/player/model/RewardGameHistoryData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/RewardGameHistoryData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/RewardGameHistoryData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/RewardGameHistoryData;)V
