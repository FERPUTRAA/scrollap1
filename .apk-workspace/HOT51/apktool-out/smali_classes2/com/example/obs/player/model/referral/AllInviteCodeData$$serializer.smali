.class public final Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/referral/AllInviteCodeData;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/referral/AllInviteCodeData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/referral/AllInviteCodeData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;->INSTANCE:Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.referral.AllInviteCodeData"
    ...
    const-string v0, "rechargeNum"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    const-string v0, "registerNum"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    const-string v0, "retentionNum"
    ...
    sput-object v1, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/referral/AllInviteCodeData;
    .locals 23
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-direct/range {v10 .. v20}, Lcom/example/obs/player/model/referral/AllInviteCodeData;-><init>(IIILjava/lang/String;IIIILjava/lang/String;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/referral/AllInviteCodeData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/referral/AllInviteCodeData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/referral/AllInviteCodeData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/referral/AllInviteCodeData;->write$Self(Lcom/example/obs/player/model/referral/AllInviteCodeData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/referral/AllInviteCodeData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/referral/AllInviteCodeData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/referral/AllInviteCodeData;)V
