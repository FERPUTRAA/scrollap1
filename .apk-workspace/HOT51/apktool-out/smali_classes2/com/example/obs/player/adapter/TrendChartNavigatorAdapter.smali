.class public final Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;
.super Lf9/a;
.source "SourceFile"
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;",
        "Lf9/a;",
        "",
        "getCount",
...
.method public constructor <init>(Landroidx/viewpager/widget/ViewPager;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;->viewPager:Landroidx/viewpager/widget/ViewPager;

    iput-object p2, p0, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;->titles:Ljava/util/List;

    return-void
.end method

.method public static synthetic a(Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;ILandroid/view/View;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;->getTitleView$lambda$0(Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;ILandroid/view/View;)V

    return-void
.end method

.method private static final getTitleView$lambda$0(Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;ILandroid/view/View;)V
    .locals 0
    ...
    iget-object p0, p0, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;->viewPager:Landroidx/viewpager/widget/ViewPager;
...
.method public getCount()I
    ...
    iget-object v0, p0, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;->titles:Ljava/util/List;
...
.method public getTitleView(Landroid/content/Context;I)Lf9/d;
    ...
    :goto_0
    new-instance v1, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter$getTitleView$simplePagerTitleView$1;

    invoke-direct {v1, p1}, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter$getTitleView$simplePagerTitleView$1;-><init>(Landroid/content/Context;)V

    iget-object p1, p0, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;->titles:Ljava/util/List;
    ...
    new-instance p1, Lcom/example/obs/player/adapter/w;

    invoke-direct {p1, p0, p2}, Lcom/example/obs/player/adapter/w;-><init>(Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;I)V
...
.method public final getViewPager()Landroidx/viewpager/widget/ViewPager;
    ...
    iget-object v0, p0, Lcom/example/obs/player/adapter/TrendChartNavigatorAdapter;->viewPager:Landroidx/viewpager/widget/ViewPager;
