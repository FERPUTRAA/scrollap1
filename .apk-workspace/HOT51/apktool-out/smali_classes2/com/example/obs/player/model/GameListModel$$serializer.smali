.class public final Lcom/example/obs/player/model/GameListModel$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/GameListModel.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/GameListModel;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/GameListModel$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/GameListModel$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/GameListModel$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/GameListModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/GameListModel$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.GameListModel"
    ...
    const-string v0, "platformShowType"
    ...
    const-string v0, "gameNameJson"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    const-string v0, "secondSpan"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    sput-object v1, Lcom/example/obs/player/model/GameListModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v1, Lcom/example/obs/player/model/GameListModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/GameListModel$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/GameListModel;
    .locals 33
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/GameListModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    new-instance v12, Lkotlinx/serialization/internal/q0;

    sget-object v13, Lkotlinx/serialization/internal/z1;->a:Lkotlinx/serialization/internal/z1;

    invoke-direct {v12, v13, v13}, Lkotlinx/serialization/internal/q0;-><init>(Lkotlinx/serialization/i;Lkotlinx/serialization/i;)V

    const/16 v13, 0xc

    invoke-interface {v0, v1, v13, v12, v4}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v12

    sget-object v13, Lcom/example/obs/player/model/GameListModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/GameListModel$$serializer;

    const/16 v15, 0xd

    invoke-interface {v0, v1, v15, v13, v4}, Lkotlinx/serialization/encoding/c;->decodeNullableSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object v11, Lcom/example/obs/player/model/GameListModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/GameListModel$$serializer;

    invoke-interface {v0, v1, v2, v11, v15}, Lkotlinx/serialization/encoding/c;->decodeNullableSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v11, v2, v2}, Lkotlinx/serialization/internal/q0;-><init>(Lkotlinx/serialization/i;Lkotlinx/serialization/i;)V

    const/16 v2, 0xc

    invoke-interface {v0, v1, v2, v11, v3}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v0, Lcom/example/obs/player/model/GameListModel;
    ...
    check-cast v29, Lcom/example/obs/player/model/GameListModel;

    const/16 v30, 0x0

    invoke-direct/range {v12 .. v30}, Lcom/example/obs/player/model/GameListModel;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ZZJIIILjava/lang/String;Ljava/util/Map;Lcom/example/obs/player/model/GameListModel;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/GameListModel$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/GameListModel;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/GameListModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/GameListModel;)V
    .locals 1
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/GameListModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/GameListModel;->write$Self(Lcom/example/obs/player/model/GameListModel;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/GameListModel;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/GameListModel$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/GameListModel;)V
