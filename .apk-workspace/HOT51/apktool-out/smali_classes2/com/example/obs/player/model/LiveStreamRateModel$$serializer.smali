.class public final Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/LiveStreamRateModel.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/LiveStreamRateModel;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.LiveStreamRateModel"
    ...
    const-string/jumbo v0, "vipGrade"
    ...
    sput-object v1, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/LiveStreamRateModel;
    .locals 19
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    new-instance v0, Lcom/example/obs/player/model/LiveStreamRateModel;

    const/16 v18, 0x0

    move-object v12, v0

    invoke-direct/range {v12 .. v18}, Lcom/example/obs/player/model/LiveStreamRateModel;-><init>(ILjava/lang/String;Ljava/lang/String;IZLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/LiveStreamRateModel;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/LiveStreamRateModel;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/LiveStreamRateModel;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/LiveStreamRateModel;->write$Self(Lcom/example/obs/player/model/LiveStreamRateModel;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/LiveStreamRateModel$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/LiveStreamRateModel;)V
