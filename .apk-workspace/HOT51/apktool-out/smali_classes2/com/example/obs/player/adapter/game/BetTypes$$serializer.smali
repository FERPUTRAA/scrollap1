.class public final Lcom/example/obs/player/adapter/game/BetTypes$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/adapter/game/BetTypes;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/adapter/game/BetTypes.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/adapter/game/BetTypes;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/adapter/game/BetTypes$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;->INSTANCE:Lcom/example/obs/player/adapter/game/BetTypes$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.adapter.game.BetTypes"
    ...
    sput-object v1, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v3, Lcom/example/obs/player/component/data/dto/GameDetailModel$BetTypeGroupDTOList$BetTypeGroups$$serializer;->INSTANCE:Lcom/example/obs/player/component/data/dto/GameDetailModel$BetTypeGroupDTOList$BetTypeGroups$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/adapter/game/BetTypes;
    .locals 29
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v4, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;->INSTANCE:Lcom/example/obs/player/adapter/game/BetTypes$$serializer;

    invoke-direct {v15, v4}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v11, v15, v3}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    new-instance v11, Lkotlinx/serialization/internal/f;

    sget-object v15, Lcom/example/obs/player/component/data/dto/GameDetailModel$BetTypeGroupDTOList$BetTypeGroups$$serializer;->INSTANCE:Lcom/example/obs/player/component/data/dto/GameDetailModel$BetTypeGroupDTOList$BetTypeGroups$$serializer;

    invoke-direct {v11, v15}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v6, v11, v3}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v2, v5}, Lkotlinx/serialization/internal/f;-><init>(Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v6, v2, v14}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v1, v11, v2, v15}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v0, Lcom/example/obs/player/adapter/game/BetTypes;
    ...
    invoke-direct/range {v11 .. v26}, Lcom/example/obs/player/adapter/game/BetTypes;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/lang/String;ZZLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/adapter/game/BetTypes;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/adapter/game/BetTypes;)V
    .locals 1
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/adapter/game/BetTypes;->write$Self(Lcom/example/obs/player/adapter/game/BetTypes;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/adapter/game/BetTypes$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/adapter/game/BetTypes;)V
