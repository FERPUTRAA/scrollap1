.class public final Lcom/example/obs/player/model/DTHistoryModel$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/DTHistoryModel.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/DTHistoryModel;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/DTHistoryModel$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/DTHistoryModel$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/DTHistoryModel$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/DTHistoryModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/DTHistoryModel$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.DTHistoryModel"
    ...
    const-string/jumbo v0, "tigerWinRate"

    invoke-virtual {v1, v0, v2}, Lkotlinx/serialization/internal/j1;->c(Ljava/lang/String;Z)V

    sput-object v1, Lcom/example/obs/player/model/DTHistoryModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    sget-object v2, Lcom/example/obs/player/model/DTHistoryModel$DTGameResultDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/DTHistoryModel$DTGameResultDTO$$serializer;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/DTHistoryModel;
    .locals 16
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/DTHistoryModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v8, Lcom/example/obs/player/model/DTHistoryModel$DTGameResultDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/DTHistoryModel$DTGameResultDTO$$serializer;
    ...
    sget-object v15, Lcom/example/obs/player/model/DTHistoryModel$DTGameResultDTO$$serializer;->INSTANCE:Lcom/example/obs/player/model/DTHistoryModel$DTGameResultDTO$$serializer;
    ...
    new-instance v0, Lcom/example/obs/player/model/DTHistoryModel;
    ...
    invoke-direct/range {v3 .. v12}, Lcom/example/obs/player/model/DTHistoryModel;-><init>(ILjava/util/List;DDDLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/DTHistoryModel$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/DTHistoryModel;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/DTHistoryModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/DTHistoryModel;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/DTHistoryModel;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/DTHistoryModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/DTHistoryModel;->write$Self(Lcom/example/obs/player/model/DTHistoryModel;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/DTHistoryModel;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/DTHistoryModel$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/DTHistoryModel;)V
