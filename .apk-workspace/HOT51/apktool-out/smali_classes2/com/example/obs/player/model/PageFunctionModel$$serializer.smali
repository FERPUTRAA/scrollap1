.class public final Lcom/example/obs/player/model/PageFunctionModel$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/PageFunctionModel;
.end annotation
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/example/obs/player/model/PageFunctionModel;",
        ">;"
    }
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/PageFunctionModel.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/PageFunctionModel;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/PageFunctionModel$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/PageFunctionModel$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/PageFunctionModel$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/PageFunctionModel$$serializer;->INSTANCE:Lcom/example/obs/player/model/PageFunctionModel$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.PageFunctionModel"
    ...
    sput-object v1, Lcom/example/obs/player/model/PageFunctionModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/PageFunctionModel;
    .locals 22
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/PageFunctionModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    new-instance v0, Lcom/example/obs/player/model/PageFunctionModel;

    const/16 v21, 0x0

    move-object v14, v0

    invoke-direct/range {v14 .. v21}, Lcom/example/obs/player/model/PageFunctionModel;-><init>(IILjava/lang/String;Ljava/lang/String;IILkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/PageFunctionModel$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/PageFunctionModel;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/PageFunctionModel$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/PageFunctionModel;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/PageFunctionModel;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/PageFunctionModel$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/PageFunctionModel;->write$Self(Lcom/example/obs/player/model/PageFunctionModel;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/PageFunctionModel$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/PageFunctionModel;)V
