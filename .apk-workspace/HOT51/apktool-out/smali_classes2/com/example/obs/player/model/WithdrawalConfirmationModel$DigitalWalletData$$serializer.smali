.class public final Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/WithdrawalConfirmationModel.DigitalWalletData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;->INSTANCE:Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.WithdrawalConfirmationModel.DigitalWalletData"
    ...
    const-string/jumbo v0, "walletType"
    ...
    sput-object v1, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;
    .locals 33
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    new-instance v0, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;

    const/16 v29, 0x0

    move-object v14, v0

    invoke-direct/range {v14 .. v29}, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;-><init>(IJILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZILjava/lang/String;ZZLjava/lang/String;Ljava/lang/String;Lkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;->write$Self(Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/WithdrawalConfirmationModel$DigitalWalletData;)V
