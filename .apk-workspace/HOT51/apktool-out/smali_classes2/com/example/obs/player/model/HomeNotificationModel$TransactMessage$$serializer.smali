.class public final Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/HomeNotificationModel.TransactMessage.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;->INSTANCE:Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.HomeNotificationModel.TransactMessage"
    ...
    sput-object v1, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;
    .locals 23
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-direct/range {v10 .. v20}, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;-><init>(ILjava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;IILkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;->write$Self(Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/HomeNotificationModel$TransactMessage;)V
