.class public final Lcom/example/obs/player/model/RechargeData$$serializer;
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/RechargeData.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/RechargeData;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/RechargeData$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/RechargeData$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/RechargeData$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/RechargeData$$serializer;->INSTANCE:Lcom/example/obs/player/model/RechargeData$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.RechargeData"
    ...
    sput-object v1, Lcom/example/obs/player/model/RechargeData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/RechargeData;
    .locals 30
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/RechargeData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v13, Lcom/example/obs/player/model/RechargeData$MerchantBank$$serializer;->INSTANCE:Lcom/example/obs/player/model/RechargeData$MerchantBank$$serializer;

    invoke-interface {v0, v1, v10, v13, v14}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_6
    sget-object v12, Lcom/example/obs/player/model/RechargeData$MerchantBank$$serializer;->INSTANCE:Lcom/example/obs/player/model/RechargeData$MerchantBank$$serializer;

    invoke-interface {v0, v1, v10, v12, v13}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v19, Lcom/example/obs/player/model/RechargeData$MerchantBank;

    const/16 v27, 0x0

    move-object v13, v0

    invoke-direct/range {v13 .. v27}, Lcom/example/obs/player/model/RechargeData;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/example/obs/player/model/RechargeData$MerchantBank;JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/RechargeData$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/RechargeData;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/RechargeData$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/RechargeData;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/RechargeData;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/RechargeData$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/RechargeData;->write$Self(Lcom/example/obs/player/model/RechargeData;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/RechargeData;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/RechargeData$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/RechargeData;)V
