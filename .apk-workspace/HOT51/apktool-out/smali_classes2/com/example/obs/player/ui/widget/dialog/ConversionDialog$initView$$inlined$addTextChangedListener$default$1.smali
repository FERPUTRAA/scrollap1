.class public final Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;
...
.method public constructor <init>(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)V
    ...
    iput-object p1, p0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;
...
.method public afterTextChanged(Landroid/text/Editable;)V
    ...
    iget-object v1, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;
    ...
    iget-object v2, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;
    ...
    invoke-virtual {v4}, Lcom/example/obs/player/model/PriceMethodData;->getRate()D
    ...
    iget-object v4, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;

    invoke-static {v4}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getAmount$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Ljava/lang/String;
    ...
    iget-object v7, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;

    invoke-static {v7}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$isOut$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Z
    ...
    invoke-static {v7}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getPlatformsBean$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Lcom/example/obs/player/model/PlatformBalanceData$Platform;

    move-result-object v7

    invoke-virtual {v7}, Lcom/example/obs/player/model/PlatformBalanceData$Platform;->getScore()Ljava/lang/String;
    ...
    invoke-static {v7}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getTransferRate$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Ljava/math/BigDecimal;

    move-result-object v7

    sget-object v8, Ljava/math/RoundingMode;->DOWN:Ljava/math/RoundingMode;

    invoke-virtual {v4, v7, v5, v8}, Ljava/math/BigDecimal;->divide(Ljava/math/BigDecimal;ILjava/math/RoundingMode;)Ljava/math/BigDecimal;
    ...
    :cond_7
    iget-object v9, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;

    invoke-static {v8, v1}, Lkotlin/ranges/s;->D(Ljava/lang/Comparable;Ljava/lang/Comparable;)Ljava/lang/Comparable;

    move-result-object v10

    const-string v11, "currencyInSenDecimal.coe\u2026t(balanceCurrencyDecimal)"
    ...
    invoke-static {v9, v10}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$setCurrencyInputDecimal$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;Ljava/math/BigDecimal;)V

    invoke-static {}, Lcom/example/obs/player/constant/UserConfig;->getPriceMethod()Lcom/example/obs/player/model/PriceMethodData;

    move-result-object v9

    invoke-virtual {v9}, Lcom/example/obs/player/model/PriceMethodData;->getRate()D
    ...
    iget-object v10, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;

    invoke-static {v10}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getCurrencyInputDecimal$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Ljava/math/BigDecimal;

    move-result-object v10

    sget-object v11, Ljava/math/MathContext;->DECIMAL64:Ljava/math/MathContext;

    invoke-virtual {v10, v9, v11}, Ljava/math/BigDecimal;->divide(Ljava/math/BigDecimal;Ljava/math/MathContext;)Ljava/math/BigDecimal;

    move-result-object v10

    iget-object v11, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;

    invoke-static {v11}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getTransferRate$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Ljava/math/BigDecimal;
    ...
    invoke-static {v9}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getCurrencyInputDecimal$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Ljava/math/BigDecimal;
    ...
    invoke-virtual {v9, v12, v13}, Ljava/math/BigDecimal;->setScale(ILjava/math/RoundingMode;)Ljava/math/BigDecimal;
    ...
    :goto_1
    invoke-static {v11, v9}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$setGameInputDecimal$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;Ljava/math/BigDecimal;)V

    invoke-virtual {v8, v1}, Ljava/math/BigDecimal;->compareTo(Ljava/math/BigDecimal;)I

    move-result v1

    const-string v8, "binding.etCurrencyInput"

    const-string v9, "currencyTextWatcher"
    ...
    :cond_9
    invoke-virtual {v1, v11}, Landroid/widget/TextView;->removeTextChangedListener(Landroid/text/TextWatcher;)V
    ...
    iget-object v12, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;

    invoke-static {v12}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getCurrencyInputDecimal$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Ljava/math/BigDecimal;
    ...
    invoke-static {v12}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getCurrencyTextWatcher$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Landroid/text/TextWatcher;
    ...
    invoke-virtual {v11, v1}, Landroid/widget/TextView;->setFilters([Landroid/text/InputFilter;)V
    ...
    const-string v12, "gameTextWatcher"
    ...
    invoke-static {v4}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getGameInputDecimal$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Ljava/math/BigDecimal;
    ...
    :goto_2
    iget-object v5, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;
    ...
    iget-object v5, v5, Lcom/example/obs/player/databinding/DialogConversionBinding;->edtGameAmount:Lcom/example/obs/player/ui/widget/NoPasteEditText;
    ...
    iget-object v4, v4, Lcom/example/obs/player/databinding/DialogConversionBinding;->edtGameAmount:Lcom/example/obs/player/ui/widget/NoPasteEditText;

    iget-object v5, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;

    invoke-static {v5}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getGameTextWatcher$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Landroid/text/TextWatcher;
    ...
    const-string v3, "goldBalanceDecimal"

    invoke-static {v10, v3}, Lkotlin/jvm/internal/l0;->o(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v10}, Lcom/example/obs/player/utils/MathUtilsKt;->divHundred(Ljava/math/BigDecimal;)Ljava/math/BigDecimal;
    ...
    sget-object v11, Lcom/example/obs/player/utils/CalculationMode;->Normal:Lcom/example/obs/player/utils/CalculationMode;
    ...
    iget-object v3, v0, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog$initView$$inlined$addTextChangedListener$default$1;->this$0:Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;

    invoke-static {v3}, Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;->access$getCurrencyTextWatcher$p(Lcom/example/obs/player/ui/widget/dialog/ConversionDialog;)Landroid/text/TextWatcher;
