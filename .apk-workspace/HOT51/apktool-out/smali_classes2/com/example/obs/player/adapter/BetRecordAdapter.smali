.class public final Lcom/example/obs/player/adapter/BetRecordAdapter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;
    }
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "Lcom/example/obs/player/adapter/BetRecordAdapter;",
        "Lcom/example/obs/player/adapter/BaseRecyclerAdapter;",
        "Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;",
        "Lcom/example/obs/player/component/data/dto/UserOrderHisDto$Record;",
        "",
        ...
        "(J)V",
        "<init>",
        "(Lcom/example/obs/player/ui/fragment/mine/BetRecordFragment;)V",
        "CountViewHolder",
        "app_y501Release"
    }
    k = 0x1
...
# instance fields
.field private final fragment:Lcom/example/obs/player/ui/fragment/mine/BetRecordFragment;
...
# direct methods
.method public constructor <init>(Lcom/example/obs/player/ui/fragment/mine/BetRecordFragment;)V
    .locals 2
    .param p1    # Lcom/example/obs/player/ui/fragment/mine/BetRecordFragment;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    iput-object p1, p0, Lcom/example/obs/player/adapter/BetRecordAdapter;->fragment:Lcom/example/obs/player/ui/fragment/mine/BetRecordFragment;

    return-void
.end method

.method public static synthetic a(Lcom/example/obs/player/adapter/BetRecordAdapter;I)V
    .locals 0

    invoke-static {p0, p1}, Lcom/example/obs/player/adapter/BetRecordAdapter;->onCreateViewHolder$lambda$0(Lcom/example/obs/player/adapter/BetRecordAdapter;I)V

    return-void
.end method

.method private static final onCreateViewHolder$lambda$0(Lcom/example/obs/player/adapter/BetRecordAdapter;I)V
    .locals 1
    ...
    iget-object v0, p0, Lcom/example/obs/player/adapter/BetRecordAdapter;->itemOnClickListener:Lcom/example/obs/player/interfaces/BaseItemOnClickListener;
...
.method private final startCountDown(JLandroid/widget/TextView;)Lkotlinx/coroutines/n2;
    ...
    iget-object v0, p0, Lcom/example/obs/player/adapter/BetRecordAdapter;->fragment:Lcom/example/obs/player/ui/fragment/mine/BetRecordFragment;
    ...
    new-instance v0, Lcom/example/obs/player/adapter/BetRecordAdapter$startCountDown$1;
    ...
    invoke-direct/range {v4 .. v9}, Lcom/example/obs/player/adapter/BetRecordAdapter$startCountDown$1;-><init>(JLandroid/widget/TextView;Lcom/example/obs/player/adapter/BetRecordAdapter;Lkotlin/coroutines/d;)V
...
.method public final getFragment()Lcom/example/obs/player/ui/fragment/mine/BetRecordFragment;
    .locals 1
    .annotation build Loa/d;
    .end annotation
...
.method public final getServiceTimeOffset()J
    ...
    iget-wide v0, p0, Lcom/example/obs/player/adapter/BetRecordAdapter;->serviceTimeOffset:J
...
.method public bridge synthetic onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$g0;I)V
    ...
    check-cast p1, Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/adapter/BetRecordAdapter;->onBindViewHolder(Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;I)V

    return-void
.end method

.method public onBindViewHolder(Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;I)V
    .locals 11
    .param p1    # Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p1}, Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;->getJob()Lkotlinx/coroutines/n2;
    ...
    const-string v2, "#feefd0"

    const/16 v3, 0x8

    const/4 v4, 0x0

    const-string v5, "game.undraw"

    const-string v6, "#ffa900"
    ...
    const-string v1, "game.not.win"

    invoke-virtual {p0, v1}, Lcom/example/obs/player/adapter/BaseRecyclerAdapter;->getStringResource(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "game.cancel.order"
    ...
    invoke-virtual {p0, v5}, Lcom/example/obs/player/adapter/BaseRecyclerAdapter;->getStringResource(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-wide v7, p0, Lcom/example/obs/player/adapter/BetRecordAdapter;->serviceTimeOffset:J
    ...
    iget-wide v9, p0, Lcom/example/obs/player/adapter/BetRecordAdapter;->serviceTimeOffset:J
    ...
    invoke-virtual {v4, v7, v8}, Lcom/example/obs/player/utils/DateTimeUtil;->toCalendar(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Calendar;
    ...
    invoke-direct {p0, v3, v4, p2}, Lcom/example/obs/player/adapter/BetRecordAdapter;->startCountDown(JLandroid/widget/TextView;)Lkotlinx/coroutines/n2;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;->setJob(Lkotlinx/coroutines/n2;)V
...
.method public bridge synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$g0;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/adapter/BetRecordAdapter;->onCreateViewHolder(Landroid/view/ViewGroup;I)Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;
    .locals 2
    ...
    new-instance p2, Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;

    invoke-direct {p2, p1}, Lcom/example/obs/player/adapter/BetRecordAdapter$CountViewHolder;-><init>(Landroid/view/View;)V

    new-instance p1, Lcom/example/obs/player/adapter/c;

    invoke-direct {p1, p0}, Lcom/example/obs/player/adapter/c;-><init>(Lcom/example/obs/player/adapter/BetRecordAdapter;)V
...
.method public final setItemOnClickListener(Lcom/example/obs/player/interfaces/BaseItemOnClickListener;)V
    ...
    iput-object p1, p0, Lcom/example/obs/player/adapter/BetRecordAdapter;->itemOnClickListener:Lcom/example/obs/player/interfaces/BaseItemOnClickListener;
...
.method public final setServiceTimeOffset(J)V
    ...
    iput-wide p1, p0, Lcom/example/obs/player/adapter/BetRecordAdapter;->serviceTimeOffset:J
