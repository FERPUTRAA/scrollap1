.class public final Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/example/obs/player/model/LiveFilterGameData$Record;
.end annotation
...
.annotation runtime Lkotlin/i0;
    ...
    d2 = {
        "com/example/obs/player/model/LiveFilterGameData.Record.$serializer",
        "Lkotlinx/serialization/internal/c0;",
        "Lcom/example/obs/player/model/LiveFilterGameData$Record;",
        "",
...
# static fields
.field public static final INSTANCE:Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;

    invoke-direct {v0}, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;-><init>()V

    sput-object v0, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->INSTANCE:Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;

    new-instance v1, Lkotlinx/serialization/internal/j1;

    const-string v2, "com.example.obs.player.model.LiveFilterGameData.Record"
    ...
    sput-object v1, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;
...
.method public childSerializers()[Lkotlinx/serialization/i;
    ...
    invoke-direct {v3, v1, v1}, Lkotlinx/serialization/internal/q0;-><init>(Lkotlinx/serialization/i;Lkotlinx/serialization/i;)V
...
.method public deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/LiveFilterGameData$Record;
    .locals 24
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-direct {v13, v14, v14}, Lkotlinx/serialization/internal/q0;-><init>(Lkotlinx/serialization/i;Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v4, v13, v12}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :pswitch_2
    new-instance v9, Lkotlinx/serialization/internal/q0;

    sget-object v3, Lkotlinx/serialization/internal/z1;->a:Lkotlinx/serialization/internal/z1;

    invoke-direct {v9, v3, v3}, Lkotlinx/serialization/internal/q0;-><init>(Lkotlinx/serialization/i;Lkotlinx/serialization/i;)V

    invoke-interface {v0, v1, v4, v9, v10}, Lkotlinx/serialization/encoding/c;->decodeSerializableElement(Lkotlinx/serialization/descriptors/f;ILkotlinx/serialization/d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v10 .. v22}, Lcom/example/obs/player/model/LiveFilterGameData$Record;-><init>(ILjava/lang/String;JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/util/Map;IZLkotlinx/serialization/internal/u1;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->deserialize(Lkotlinx/serialization/encoding/e;)Lcom/example/obs/player/model/LiveFilterGameData$Record;
...
.method public getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    sget-object v0, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->descriptor:Lkotlinx/serialization/internal/j1;

    return-object v0
.end method

.method public serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/LiveFilterGameData$Record;)V
    .locals 1
    .param p1    # Lkotlinx/serialization/encoding/g;
        .annotation build Loa/d;
        .end annotation
    .end param
    .param p2    # Lcom/example/obs/player/model/LiveFilterGameData$Record;
        .annotation build Loa/d;
        .end annotation
    .end param
    ...
    invoke-virtual {p0}, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->getDescriptor()Lkotlinx/serialization/descriptors/f;
    ...
    invoke-static {p2, p1, v0}, Lcom/example/obs/player/model/LiveFilterGameData$Record;->write$Self(Lcom/example/obs/player/model/LiveFilterGameData$Record;Lkotlinx/serialization/encoding/d;Lkotlinx/serialization/descriptors/f;)V
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/g;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/example/obs/player/model/LiveFilterGameData$Record;

    invoke-virtual {p0, p1, p2}, Lcom/example/obs/player/model/LiveFilterGameData$Record$$serializer;->serialize(Lkotlinx/serialization/encoding/g;Lcom/example/obs/player/model/LiveFilterGameData$Record;)V
