...
.field final b:Lcom/google/common/util/concurrent/b2;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Ljava/util/concurrent/Future;Lcom/google/common/util/concurrent/b2;)V
    .locals 0
    ...
    iput-object p1, p0, Lcom/google/common/util/concurrent/e2$b;->a:Ljava/util/concurrent/Future;

    iput-object p2, p0, Lcom/google/common/util/concurrent/e2$b;->b:Lcom/google/common/util/concurrent/b2;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/google/common/util/concurrent/e2$b;->a:Ljava/util/concurrent/Future;
    ...
    iget-object v1, p0, Lcom/google/common/util/concurrent/e2$b;->b:Lcom/google/common/util/concurrent/b2;

    invoke-interface {v1, v0}, Lcom/google/common/util/concurrent/b2;->onFailure(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v0}, Lcom/google/common/util/concurrent/b2;->onSuccess(Ljava/lang/Object;)V
