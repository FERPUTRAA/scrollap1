...
.method private static a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-static {p0, p1, v0, v1, v2}, Lcom/google/firebase/crashlytics/internal/common/v;->b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method private static b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
    ...
    new-instance v8, Lcom/google/firebase/crashlytics/internal/common/v$b;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/google/firebase/crashlytics/internal/common/v$b;-><init>(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method public static c(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {p0}, Lcom/google/firebase/crashlytics/internal/common/v;->e(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/crashlytics/internal/common/v;->f(Ljava/util/concurrent/ThreadFactory;Ljava/util/concurrent/RejectedExecutionHandler;)Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    invoke-static {p0, v0}, Lcom/google/firebase/crashlytics/internal/common/v;->a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
...
.method public static e(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v1, p0, v0}, Lcom/google/firebase/crashlytics/internal/common/v$a;-><init>(Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicLong;)V
